var ctxfolder = "/views/mobile/dashBoardDigital/";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        getCountFile: function (callback) {
            $http.get('/DashBoardBuyer/GetCountFile/').then(callback);
        },
        getActionFile: function (callback) {
            $http.get('/DashBoardBuyer/GetActionFile/').then(callback);
        },
        amchartFile: function (callback) {
            $http.get('/DashBoardBuyer/AmchartFile/').then(callback);
        },
    ...
    $scope.initData = function () {
        ...
        dataservice.amchartFile(function (rs) {
            ...
            for (var i = 0; i < rs.length; i++) {
                ...
                monthfile.push('Tháng ' + (rs[i].Month));
            }
            require(['c3', 'jquery'], function (c3, $) {
                $(document).ready(function () {
                    var chart = c3.generate({
