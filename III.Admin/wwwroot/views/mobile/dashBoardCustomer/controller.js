var ctxfolder = "/views/mobile/dashBoardCustomer/";
var ctxfolderMessage = "/views/message-box";

var app = angular.module('App_ESEIM', ["ui.bootstrap", "ngRoute", "ngValidate", "ngCookies", "pascalprecht.translate"]). directive("filesInput", function () {
        return {
            require: "ngModel",
...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        getActionCustomer: function (callback) {
            $http.get('/DashBoardBuyer/GetActionCustomer/').then(callback);
        },
        getCountCustomer: function (callback) {
            $http.get('/DashBoardBuyer/GetCountCustomer/').then(callback);
        },
        amchartCustomer: function (callback) {
            $http.get('/DashBoardBuyer/AmchartCustomer/').then(callback);
        },
        getActionSupplier: function (callback) {
            $http.get('/DashBoardBuyer/GetActionSupplier/').then(callback);
        },
        getCountSupplier: function (callback) {
            $http.get('/DashBoardBuyer/GetCountSupplier/').then(callback);
        },
        amchartSupplier: function (callback) {
            $http.get('/DashBoardBuyer/AmchartSupplier/').then(callback);
        },
    ...
    $scope.initData = function () {
        ...
        dataservice.amchartCustomer(function (rs) {
            ...
            for (var i = 0; i < rs.length; i++) {
                ...
                monthcus.push('Tháng ' + (rs[i].Month));
            }
