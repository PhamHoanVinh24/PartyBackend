var ctxfolder = "/views/mobile/dashBoardSale/";
...
app.controller('index', function ($scope,  dataservice) {
    $scope.initData = function () {
        dataservice.getCountSale(function (rs) {
            ...
            $scope.SaleMoney = (rs.Summoney).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            $scope.SaleMonrydepending = (rs.Summoneydepend).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            $scope.SaleMoneySucess = (rs.Summoneysucess).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            $scope.SaleMoneyCancel = (rs.Summoneycancel).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");

            $scope.SummoneyIn = (rs.SummoneyIn).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            $scope.SummoneydependIn = (rs.SummoneydependIn).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            $scope.SummoneysucessIn = (rs.SummoneysucessIn).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            $scope.SummoneycancelIn = (rs.SummoneycancelIn).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        ...
        dataservice.amchartCountSale(function (rs) {
            ...
            for (var i = 0; i < rs.length; i++) {
                ...
                monthsale.push('Tháng ' + (rs[i].Month));
            }
