var ctxfolder = "/views/mobile/dashBoardBuyer/";
...
app.controller('index', function ($scope,  dataservice) {
    $scope.initData = function () {
        dataservice.getCountBuyer(function (rs) {
            ...
            $scope.Moneypeding = (rs.Moneypeding).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            $scope.MoneypSuccess = (rs.MoneypSuccess).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            $scope.MoneyCancel = (rs.MoneyCancel).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");

            $scope.summoneyOut = (rs.summoneyOut).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            $scope.SummoneydependOut = (rs.SummoneydependOut).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            $scope.SummoneysucessOut = (rs.SummoneysucessOut).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            $scope.SummoneycancelOut = (rs.SummoneycancelOut).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        ...
        dataservice.amchartCountBuy(function (rs) {
            ...
            for (var i = 0; i < rs.length; i++) {
                ...
                monthbuy.push('Tháng ' + (rs[i].Month));
            }
