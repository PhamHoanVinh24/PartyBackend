...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        getPartyAdmissionProfileByUserCode: function (data, callback) { $http.post('"/UserProfile/GetPartyAdmissionProfileByUserCode?userCode="', data).then(callback); },
...
app.controller('index', function ($scope, $rootScope, $compile, dataservice, $filter,$http) {
    ...
    $scope.ProfileList=[]
    function getPartyAdmissionProfileByResumeNumber () {
        $.ajax({
            type: "POST",
            url: "/UserProfile/GetPartyAdmissionProfileByResumeNumber?resumeNumber=20241552",// gán $scope.infUser.resumenumber
    ...
    $scope.user = { id: 13 }
    function getPartyAdmissionProfileByUserCode() {
        $.ajax({
            type: "POST",
