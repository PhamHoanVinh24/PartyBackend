...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $window, $filter) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ID').withTitle('ID').withOption('sClass', ' dataTable-pr0 w20').renderWith(function (data, type) {
        return data;
    }));
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('TableName').withTitle('{{"JCOBJTYPE_LIST_COL_TABLE_NAME"|translate}}').withOption('sClass', 'dataTable-pr0 w110').renderWith(function (data, type) {
        return data;
    }));
