...
app.factory('dataserviceRPT', function ($http) {
    ...
    return {
        ...
        getItemRPT: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/GetItem?Id=' + data).then(callback);
        },
        getBranch: function (callback) {
            $http.post('/Admin/AssetRPTBroken/GetBranch').then(callback);
        },
        getPerson: function (callback) {
            $http.post('/Admin/AssetRPTBroken/GetPerson').then(callback);
        },
        getAssetStatus: function (callback) {
            $http.post('/Admin/AssetRPTBroken/GetAssetStatus').then(callback);
        },
        insert: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/Insert', data).then(callback);
        },
        updateRPT: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/Update?Id=', data).then(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/Delete?Id=' + data).then(callback);
        },
        getGenReqCode: function (callback) {
            $http.post('/Admin/AssetRPTBroken/GenReqCode').then(callback);
        },
        deleteAsset: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/DeleteAsset?Id=' + data).then(callback);
        },
        getAttrName: function (callback) {
            $http.post('/Admin/AssetRPTBroken/GetAttrName').then(callback);
        },
        // insert Thêm tài sản
        getAssset: function (callback) {
            $http.post('/Admin/AssetRPTBroken/GetAssset').then(callback);
        },
        getStatusAsset: function (callback) {
            $http.post('/Admin/AssetRPTBroken/GetStatusAsset').then(callback);
        },
        insertAsset: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/InsertAsset/', data).then(callback);
        },
        getActivityStatus: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/GetActivityStatus?Id=' + data).then(callback);
        },
        getItemDetails: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/GetItemDetails?Id=' + data).then(callback);
        },
        insertFile: function (data, callback) {
            submitFormUpload('/Admin/AssetRPTBroken/UploadFile', data, callback);
        },
        getGenReqFileCode: function (callback) {
            $http.post('/Admin/AssetRPTBroken/GenReqFileCode').then(callback);
        },
        getListFile: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/GetListFile?code=' + data, callback).then(callback);
        },
        deleteFile: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/DeleteFile?id=' + data).then(callback);
        },
        genReqFileCode: function (callback) {
            $http.post('/Admin/AssetRPTBroken/GenReqFileCode').then(callback);
        },
        getAttrDataType: function (callback) {
            $http.post('/Admin/AssetRPTBroken/GetAttrDataType/').then(callback);
        },
        getCatObjActivity: function (callback) {
            $http.post('/Admin/AssetRPTBroken/GetCatObjActivity').then(callback);
        },
        getAttrUnit: function (callback) {
            $http.post('/Admin/AssetRPTBroken/GetAttrUnit/').then(callback);
        },
        insertLogData: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/InsertLogData', data).then(callback);
        },
        ...
        deleteAttrData: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/DeleteAttrData?id=' + data).then(callback);
        },
        deleteItemActivity: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/DeleteItemActivity?id=' + data).then(callback);
        },
        ...
        insertAssetFile: function (data, callback) {
            submitFormUpload1('/Admin/AssetRPTBroken/InsertAssetFile/', data, callback);
        },
        getSuggestionsAssetFile: function (data, callback) {
            $http.get('/Admin/AssetRPTBroken/GetSuggestionsAssetFile?assetCode=' + data).then(callback);
        },
        ...
        getAssetFile: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/GetAssetFile/' + data).then(callback);
        },
        updateAssetFile: function (data, callback) {
            submitFormUpload('/Admin/AssetRPTBroken/UpdateAssetFile/', data, callback);
        },
        deleteAssetFile: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/DeleteAssetFile/' + data).then(callback);
        },
        ...
        getAssetInTicket: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/GetAssetInTicket?ticketCode=' + data).then(callback);
        },
        ...
        getStepWorkFlow: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/GetStepWorkFlow?code=' + data).then(callback);
        },
        ...
        getItemTemp: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/GetItemTemp?id=' + data).then(callback)
        },
        getListRepeat: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/GetListRepeat?code=' + data).then(callback);
        },
        getActionStatus: function (data, callback) {
            $http.get('/Admin/AssetRPTBroken/GetActionStatus?code=' + data).then(callback);
        },

        getLogStatus: function (data, callback) {
            $http.post('/Admin/AssetRPTBroken/GetLogStatus?code=' + data).then(callback);
        },
...
app.controller('Ctrl_ESEIM_RPT', function ($scope, $rootScope, $compile, $uibModal, dataserviceRPT, $cookies, $translate) {
    ...
    $rootScope.$on('$translateChangeSuccess', function () {
        ...
        $rootScope.validationOptions = {
            ...
            messages: {
                Ticket: {
                    required: caption.ASSET_VALIDATE_TITLE,
                    maxlength: caption.ASSET_VALIDATE_LENGTH_TITLE,
                },
                StartTime: {
                    required: "Ngày phát hiện không được bỏ trống"
                }
            },
        };
        $rootScope.validationOptionsasset = {
            ...
            messages: {
                Quantity: {
                    required: caption.ASSET_VALIDATE_QUANTITY,
                    regx: caption.ASSET_VALIDATE_REGEX_QUANTITY
                },
        ...
        $rootScope.validationOptionsResultAct = {
            ...
            messages: {
                Value: {
                    required: caption.ASSET_VALIDATE_VALUE
                }
            }
        }
    });
    dataserviceRPT.getAssetStatus(function (result) {
        result = result.data;
        $rootScope.listAssetStatus = result;
    });
    dataserviceRPT.getBranch(function (result) {
        result = result.data;
        $rootScope.listBranch = result;
    });
    dataserviceRPT.getPerson(function (result) {
        result = result.data;
        $rootScope.listPerson = result;
    });
    //insert Thêm tài sản
    dataserviceRPT.getAssset(function (result) {
        result = result.data;
        $rootScope.listAssset = result;
    });
    dataserviceRPT.getStatusAsset(function (result) {
        result = result.data;
        $rootScope.listStatusAsset = result;
    });
    dataserviceRPT.getAttrName(function (result) {
        result = result.data;
        $rootScope.listAttrName = result;
    });

    $rootScope.ObjectTypeFile = "ASSET_RPT";
    $rootScope.moduleName = "ASSET"
});

app.config(function ($routeProvider, $validatorProvider, $translateProvider) {
    $translateProvider.useUrlLoader('/Admin/AssetRPTBroken/Translation');
    caption = $translateProvider.translations();
    $routeProvider
        .when('/', {
            templateUrl: ctxfolderRPT + '/index.html',
            controller: 'index'
        })
        .when('/map', {
            templateUrl: ctxfolderRPT + '/google-map.html',
            controller: 'google-map'
        })
        .when('/add', {
            templateUrl: ctxfolderRPT + '/add.html',
            controller: 'add'
        })
        .when('/edit', {
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, $location) {
    $scope.modelsearch = {
        TicketCode: "",
        Ticket: "",
        FromDate: "",
    ...
    $scope.cancel = function () {
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: ctxfolderRPT + '/cancel.html',
            controller: 'cancel',
            backdrop: true,
            size: '70'
        });
...
app.controller('assetRPT', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRPT, $filter, $translate) {
    var vm = $scope;
    $scope.model = {
        AssetID: '',
        //StoreCode: '',
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/AssetRPTBroken/JTable",
            ...
            type: 'POST',
            data: function (d) {
                d.DateFrom = $scope.modelsearch.DateFrom;
                d.DateTo = $scope.modelsearch.DateTo;
                d.Phone = $scope.modelsearch.Phone;
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('AssetCode').withTitle('{{"ASSET_LIST_COL_ASSET_CODE" | translate}}').renderWith(function (data, type, full) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('AssetName').withTitle('{{"ASSET_LIST_COL_ASSET_NAME" | translate}}').withOption('sWidth', '30px').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Quantity').withTitle('{{"ASSET_LIST_COL_QUANTITY" | translate}}').withOption('sWidth', '30px').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('StartTime').withTitle('{{"ASSET_LIST_COL_DATE" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('AssetStatus').withTitle('{{"ASSET_LIST_COL_STATUS" | translate}}').renderWith(function (data, type, full) {
        debugger
        var json = JSON.parse(full.AssetStatus);
        var status = "";
        if (json.length > 0) {
    ...
    $rootScope.reloadDetails = function () {
        reloadData(false);
    };
    $scope.edit = function (id) {
        dataserviceRPT.getItemDetails(id, function (rs) {
            rs = rs.data;
            var modalInstance = $uibModal.open({
                animation: true,
                templateUrl: ctxfolderRPT + '/edit.html',
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                $scope.ok = function () {
                    dataserviceRPT.deleteAsset(id, function (rs) {
                        rs = rs.data;
                        if (rs.Error) {
...
app.controller('ticketRPT', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRPT, $filter, myService, $location) {
    var vm = $scope;
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/AssetRPTBroken/JTableTicket",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('AssetID').withTitle('ID').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('TicketCode').withTitle('{{"ASSET_LIST_COL_TICKETCODE" | translate}}').renderWith(function (data, type, full) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Ticket').withTitle('{{"ASSET_LIST_COL_TITLE_TICKET" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Branch').withTitle('{{"ASSET_LIST_COL_BRANCH" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('StartTime').withTitle('{{"ASSET_LIST_COL_DATE" | translate}}').renderWith(function (data, type) {
        return data != null && data != "" ? $filter('date')(new Date(data), 'dd/MM/yyyy') : null;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Person').withTitle('{{"ASSET_LIST_COL_PERSON" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('AssetStatus').withTitle('{{"ASSET_LIST_COL_STATUS" | translate}}').renderWith(function (data, type, full) {
        var json = JSON.parse(full.AssetStatus)
    ...
    $scope.edit = function (id) {
        dataserviceRPT.getItemRPT(id, function (rs) {
            rs = rs.data;
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                $scope.message = caption.COM_MSG_DELETE_CONFIRM.replace('{0}', "");
                $scope.ok = function () {
                    dataserviceRPT.delete(id, function (rs) {
                        rs = rs.data;
                        if (rs.Error) {
                            App.toastrError(rs.Title);
                        } else {
...
app.controller('addtable', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRPT, $filter, $translate) {
    var vm = $scope;
    $scope.modelAsset = {
        AssetID: '',
    };
    ...
    $scope.toggleAll = toggleAll;
    $scope.toggleOne = toggleOne;
    $scope.modelAsset = { AssetCode: '' };
    var titleHtml = '<label class="mt-checkbox"><input type="checkbox" ng-model="selectAll" ng-click="toggleAll(selectAll, selected)"/><span></span></label>';
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/AssetRPTBroken/JTableAdd",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
            ...
            complete: function () {
                App.unblockUI("#contentMain");
                heightTableManual(200, "#tblDataAssetRPT");
            }
        })
        .withPaginationType('full_numbers').withDOM("<'table-scrollable't>ip")
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('TicketCode').withTitle('{{"ASSET_LIST_COL_CODE" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('AssetStatus').withTitle('{{"ASSET_LIST_COL_STATUS" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Note').withTitle('{{"ASSET_LIST_COL_NOTE" | translate}}').renderWith(function (data, type) {
        return data;
    ...
    $scope.addAsset = function () {
        ...
        if ($scope.assetform.validate() && !validationSelect($scope.modelAsset).Status) {
            var msg = $rootScope.checkData($scope.modelAsset);
            if (msg.Status) {
                App.toastrError(msg.Title);
                return;
            }
            dataserviceRPT.insertAsset($scope.modelAsset, function (result) {
                result = result.data;
                if (result.Error) {
                    App.toastrError(result.Title);
                } else {
                    App.toastrSuccess(result.Title);
                    $rootScope.reloadDetails();
                    $scope.reloadData();
    ...
    $scope.changleSelect = function (SelectType) {
        ...
        if (SelectType == "AssetStatus" && $scope.modelAsset.AssetStatus != "") {
            $scope.errorAssetStatus = false;
        }
    }
    function validationSelect(data) {
        ...
        if (data.AssetStatus == "" || data.AssetStatus == null) {
            $scope.errorAssetStatus = true;
            mess.Status = true;
        } else {
            $scope.errorAssetStatus = false;
        }
...
app.controller('add', function ($scope, $rootScope, $compile, $uibModal, dataserviceRPT, $location) {
    $scope.CheckCode = '';
    ...
    $scope.modelWf = {
        WorkflowCode: "",
        ObjectType: "ASSET_RPT",
        ObjectInst: "",
    };

    $scope.listCatObjActivity = [];

    dataserviceRPT.getCatObjActivity(function (rs) {
        rs = rs.data;
    ...
    $scope.addor = function () {
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: ctxfolderRPT + '/operation.html',
    ...
    $scope.initLoad = function () {
        dataserviceRPT.getGenReqCode(function (rs) {
            rs = rs.data;
            if (!rs.Error) {
        ...
        dataserviceRPT.getWorkFlow(function (result) {
            result = result.data;
            $rootScope.lstWorkflow = result;
        });
        dataserviceRPT.getStatusAct(function (rs) {
            rs = rs.data;
            $scope.lstStatus = rs;
        })
        dataserviceRPT.suggestWF($scope.modelWf.ObjectType, function (rs) {
            rs = rs.data;
    ...
    $scope.changeWorkFlowInts = function (wfCatCode) {
        dataserviceRPT.getStepWorkFlow(wfCatCode, function (rs) {
            data = rs.data;
    ...
    $scope.chkAdd = function () {
        if ($scope.CheckCode == '') {
            App.toastrError(caption.ASSET_SET_MSG_SAVE_TICKET);
        }
    };
    ...
    $scope.submit = function () {
        ...
        if ($scope.addform.validate() && !validationSelect($scope.model).Status) {
            ...
            dataserviceRPT.insert($scope.model, function (result) {
                result = result.data;
                if (result.Error) {
                    App.toastrError(result.Title);
                } else {
                    ...
                    dataserviceRPT.createWfInstance($scope.modelWf, function (rs) {
                        rs = rs.data;
                        if (rs.Error) {
                            App.toastrError(rs.Title);
                        } else {
    ...
    $scope.addFile = function () {
        ...
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: ctxfolderRPT + '/file_add.html',
            controller: 'file_add',
            backdrop: 'static',
            size: '50'
        });
        modalInstance.result.then(function (d) {
            dataserviceRPT.getListFile($scope.model.Ticketcode, function (rs) {
                rs = rs.data;
    ...
    $scope.deleteFile = function (id) {
        dataserviceRPT.deleteFile(id, function (result) {
            result = result.data;
            if (result.Error) {
                App.toastrError(result.Title);
            } else {
    ...
    function initDateTime() {
        $("#StartTime").datepicker({
            ...
            var maxDate = new Date(selected.date.valueOf());
            var date = new Date();
            $('#StartTime').datepicker('setEndDate', date);
...
app.controller('editRPT', function ($scope, $rootScope, $compile, $uibModal, dataserviceRPT, $filter, myService, $location) {
    ...
    $scope.initData = function () {
        dataserviceRPT.getItemRPT(para, function (rs) {
            debugger
            rs = rs.data;
            $rootScope.Ticketcode = rs.Object.TicketCode;
            $rootScope.AssetCode = rs.Object.TicketCode; // de hien o ngoai  index phan edit. cua  tai san
            ...
            var lstStatus = JSON.parse($scope.model.AssetStatus);
            ...
            dataserviceRPT.checkRoleUser($scope.model.ObjActCode, function (rs) {
                rs = rs.data;
                if (rs == true) {
            ...
            dataserviceRPT.getCatActivityWorkFlow($scope.model.ObjActCode, function (rs) {

                rs = rs.data;
                $rootScope.listCatActivity = rs;
            });
            dataserviceRPT.getAssetInTicket($scope.model.Ticketcode, function (rs) {
                rs = rs.data;
                $scope.lstProd = rs;
            })
    ...
    if (para == undefined || para <= 0) {
        location.href = "/Admin/AssetRPTBroken";
    }
    ...
    $scope.changeStatus = function () {
        if ($scope.model.AssetStatus == "REPEAT_REQUIRE_REWORK" || $scope.model.AssetStatus == "FINAL_REQUIRE_REWORK") {
            dataserviceRPT.getListRepeat($scope.model.TicketCode, function (rs) {
                rs = rs.data;
                var arr = [];
    ...
    $scope.resultActivity = function () {
        if ($scope.model.ActCode != '' && $scope.model.ActCode != undefined && $scope.model.ActCode != null) {
            ...
            var modalInstance = $uibModal.open({
                animation: true,
                templateUrl: ctxfolderRPT + '/resultActivity.html',
                controller: 'resultActivity',
                backdrop: 'static',
                size: '50',
            });
        } else {
            App.toastrError(caption.ASSET_MSG_ACT_FIRST);
        }
    }
    ...
    $scope.editInstAct = function (id, objCode) {
        dataserviceRPT.checkPermissionEditActivityById(id, function (rs) {
            rs = rs.data;
            if (!rs) {
                return App.toastrError(caption.COM_MSG_PERMISSION_EDIT_ACT);
            }
            dataserviceRPT.getItemActInst(id, function (rs) {
                ...
                modalInstance.result.then(function (d) {
                    $rootScope.loadDiagramWfInst($scope.model.TicketCode, $scope.modelWf.ObjectType);
                    dataserviceRPT.getLogStatus($scope.model.TicketCode, function (rs) {
                        rs = rs.data;
                        var lstStatus = JSON.parse(rs.AssetStatus);
                        if (lstStatus.length > 0) {
                            $scope.model.Status = lstStatus[lstStatus.length - 1].Code;
                            $scope.model.StatusDefault = lstStatus[lstStatus.length - 1].Code;
                            $scope.model.StatusTemp = lstStatus[lstStatus.length - 1].Code;
    ...
    $scope.submit = function () {
        ...
        if ($scope.editform.validate() && !validationSelect($scope.model).Status) {
            dataserviceRPT.updateRPT($scope.model, function (rs) {
                rs = rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                } else {
                    ...
                    if ($scope.model.Status != "FINAL_DONE") {
                        dataserviceRPT.getActionStatus($scope.model.Ticketcode, function (rs) {
                            rs = rs.data;
                        ...
                        dataserviceRPT.getItemTemp(para, function (rs) {
                            rs = rs.data;
                            var data = rs.Object;
                            ...
                            if (data.data != undefined && data.data != "" && data.data != null) {
                                ...
                                $scope.check = false;
                                if (data.data.AssetStatus.length != undefined) {
                                    var json = JSON.parse(data.data.AssetStatus);
                                    var arr = [];
                                    arr.push(json[json.length - 1]);
                                    $scope.loghis = arr;
                                    $scope.model.AssetStatus = $scope.loghis[0].StatusCode;
                                }
                            }
                            else {
    ...
    $scope.tableActivity = function () {
        ...
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: ctxfolderRPT + '/tableActivity.html',
    ...
    $scope.print = function () {
        ...
        var content = '<p><strong>Đơn vị:</strong>................................. </p>' +
            ...
            '<p></p>' +
            '<p style="text-align: center;"><strong>PHIẾU BÁO HỎNG/MẤT TÀI SẢN</strong></p>' +
            ...
            '<p>Người phát hiện: <strong>' + personRecei + '</strong></p>' +
...
app.controller('file_add', function ($scope, $rootScope, $compile, $uibModal, $confirm, dataserviceRPT, $uibModalInstance) {
    $scope.cancel = function () {
        $uibModalInstance.dismiss('cancel');
    }
    $scope.initData = function () {
        dataserviceRPT.genReqFileCode(function (rs) {
            rs = rs.data;
    ...
    $scope.submit = function () {
        if ($scope.addformfile.validate()) {
            ...
            if (file == null || file == undefined) {
                ...
                dataserviceRPT.insertFile(formData, function (result) {
                    result = result.data;
                    if (result.Error) {
                        App.toastrError(result.Title);
                    } else {
...
app.controller('resultActivity', function ($scope, $rootScope, $uibModalInstance, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRPT, $filter) {
    $scope.model = {
        AttrCode: '',
        AttrDataType: '',
        AttrUnit: '',
    ...
    $scope.initLoad = function () {
        ...
        dataserviceRPT.getItemAttrSetup(obj, function (rs) {
            rs = rs.data;
            $scope.model.listAttrData = rs;
        });
        dataserviceRPT.getListActivityAttrData($scope.model.ObjCode, $scope.model.ActCode, $scope.model.WorkFlowCode, function (rs) {
            rs = rs.data;
    ...
    $scope.submit = function () {
        ...
        if ($scope.resultActivity.validate() && !validationSelect($scope.model).Status) {
            ...
            dataserviceRPT.insertAttrData($scope.model, function (result) {
                result = result.data;
                if (result.Error) {
                    App.toastrError(result.Title);
                } else {
    ...
    $scope.updateStatus = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                $scope.ok = function () {
                    dataserviceRPT.updateAttrData(id, function (rs) {
                        rs = rs.data;
                        if (rs.Error) {
                            App.toastrError(rs.Title);
                        } else {
        ...
        modalInstance.result.then(function (d) {
            dataserviceRPT.getListActivityAttrData($rootScope.ObjCode, $rootScope.ActCode, $rootScope.ObjActCode, function (rs) {
                rs = rs.data;
    ...
    $scope.delete = function (id) {
        dataserviceRPT.deleteAttrData(id, function (result) {
            result = result.data;
            if (result.Error) {
                App.toastrError(result.Title);
            } else {
...
app.controller('tableActivity', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRPT, $filter) {
    $scope.model = {
    }
    $index = 0;
    $scope.cancel = function () {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/AssetRPTBroken/JTableActivity",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActName').withTitle('{{"ASSET_LIST_COL_ACT" | translate}}').renderWith(function (data, type, full) {
        return '<span>' + data + '</span></br>' + '<span class="badge-customer badge-customer-success"> ' + full.Time + '</span>';
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActType').withTitle('{{"ASSET_LIST_COL_TYPE_ACT" | translate}}').withOption('sClass', 'w150').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('UserAct').withTitle('{{"User action" | translate}}').withOption('sClass', 'w150').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Result').withTitle('{{"ASSET_LIST_COL_RESULT" | translate}}').withOption('sClass', 'w350').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('action').withTitle('{{"ASSET_LIST_COL_ACTION" | translate}}').withOption('sClass', 'w20').renderWith(function (data, type, full) {
    ...
    $scope.delete = function (id) {
        ...
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance, para) {
                ...
                $scope.ok = function () {
                    dataserviceRPT.deleteItemActivity(para, function (rs) {
                        rs = rs.data;
                        if (rs.Error) {
                            App.toastrError(rs.Title);
                        } else {
...
app.controller('statusObjAct', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRPT, $filter, para) {
    $scope.cancel = function () {
        $uibModalInstance.dismiss('cancel');
    };
    $scope.ObjActCode = '';
    ...
    $scope.initLoad = function () {
        var obj = para;
        dataserviceRPT.getStausObjStream(obj, function (rs) {
            rs = rs.data;
            $scope.listStatusObj = [];
            var list = rs;
...
app.controller('fileAsset', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRPT, $filter, dataserviceSupplier) {
    var vm = $scope;
    $scope.selected = [];
    $scope.selectAll = false;
    $scope.toggleAll = toggleAll;
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/AssetRPTBroken/JTableFile",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
            ...
            complete: function () {
                App.unblockUI("#contentMain");
                heightTableManual(200, "#tblDataRptFile");
            }
        })
        .withPaginationType('full_numbers').withDOM("<'table-scrollable't>ip")
        .withDataProp('data').withDisplayLength(3)
    ...
    $scope.add = function () {
        if ($scope.file == '' || $scope.file == undefined) {
            ...
            dataserviceRPT.insertAssetFile(data, function (result) {
                result = result.data;
                if (result.Error) {
                    App.toastrError(result.Title);
                } else {
    ...
    $scope.edit = function (fileName, id) {
        dataserviceRPT.getAssetFile(id, function (rs) {
            rs = rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            }
                ...
                var modalInstance = $uibModal.open({
                    animation: true,
                    templateUrl: ctxfolderRPT + '/file_edit.html',
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                $scope.message = caption.COM_MSG_DELETE_CONFIRM_COM;
                $scope.ok = function () {
                    dataserviceRPT.deleteAssetFile(id, function (result) {
                        result = result.data;
                        if (result.Error) {
                            App.toastrError(result.Title);
                        } else {
    ...
    $scope.extend = function () {
        //dataserviceRPT.getSuggestionsAssetFile($rootScope.AssetCode, function (rs) {
        //    rs = rs.data;
        //    var data = rs != '' ? rs : {};
        //    var modalInstance = $uibModal.open({
        //        templateUrl: ctxfolderRPT + '/file_add.html',
        ...
        //    }, function () { });
        //})
        dataserviceSupplier.getDefaultRepo($rootScope.AssetCode, 'ASSET_RPT', function (rs) {
            rs = rs.data;
            var data = rs !== null ? rs : { CatCode: '', ObjectCode: $rootScope.AssetCode, ObjectType: 'ASSET_RPT' };
            var modalInstance = $uibModal.open({
    ...
    $scope.getObjectFile = function (id) {
        if (id === 0) {
            ...
            dataserviceRPT.getItemFile(id, true, function (rs) {
                rs = rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                    return null;
    ...
    $scope.viewExcel = function (id, mode) {
        if (id === 0) {
            ...
            dataserviceRPT.getItemFile(id, true, mode, function (rs) {
                rs = rs.data;
                if (rs.Error) {
                    if (rs.ID === -1) {
                        App.toastrError(rs.Title);
    ...
    $scope.view = function (id) {
        ...
        var image = ['.JPG', '.PNG', '.TIF', '.TIFF'];
        var userModel = {};
        var listdata = $('#tblDataRptFile').DataTable().data();
        for (var i = 0; i < listdata.length; i++) {
            if (listdata[i].Id == id) {
                userModel = listdata[i];
                break;
        ...
        if (userModel.CloudFileId != null && userModel.CloudFileId != "") {
            ...
            dataserviceRPT.createTempFile(id, false, "", function (rs) {
                rs = rs.data;
    ...
    $scope.openViewer = function (url, isImage) {
        ...
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: ctxfolderRPT + '/viewer.html',
            controller: 'viewer',
            backdrop: 'false',
            size: '60',
            resolve: {
    ...
    $scope.tabFileHistory = function (fileId) {
        ...
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: ctxfolderRPT + '/tabFileHistory.html',
...
app.controller('fileAddAsset', function ($scope, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, DTInstances, $uibModalInstance, dataserviceRPT, para) {
    ...
    $scope.readyCB = function () {
        if ($scope.treeDataCategory.length == 0) {
            ...
            dataserviceRPT.getTreeCategory(function (result) {
                result = result.data;
                if (!result.Error) {
                    var root = {
                        id: 'root',
...
app.controller('fileEditAsset', function ($scope, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, DTInstances, $uibModal, $uibModalInstance, dataserviceRPT, para) {
    $scope.treeDataCategory = [];
    ...
    $scope.submit = function () {
        ...
        if (itemSelect.length == 0) {
            ...
            if ($scope.editformfile.validate()) {
                ...
                data.append("NumberDocument", $scope.model.NumberDocument);
                data.append("AssetCode", $rootScope.AssetCode);
                dataserviceRPT.updateAssetFile(data, function (result) {
                    result = result.data;
                    if (result.Error) {
                        App.toastrError(result.Title);
                    } else {
...
app.controller('fileShareAsset', function ($scope, $rootScope, $compile, $uibModalInstance, dataserviceRPT) {
    $scope.model = {
    ...
    $scope.init = function () {
        dataserviceRPT.getListObjectTypeShare(function (rs) {
            rs = rs.data;
            $scope.listObjType = rs;
        });
        dataserviceRPT.getListFileWithObject($scope.model.ObjectCodeShared, $scope.model.ObjectTypeShared, function (rs) {
            rs = rs.data;
    ...
    $scope.changeObjType = function (ObjType) {
        dataserviceRPT.getListObjectCode($rootScope.AssetCode, ObjType, function (rs) {
            rs = rs.data;
    ...
    $scope.removeObjectShare = function (id) {
        dataserviceRPT.deleteObjectShare(id, function (rs) {
            rs = rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
    ...
    $scope.share = function () {
        if (!$scope.validate()) {
            dataserviceRPT.insertFileShare($scope.model, function (rs) {
                rs = rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                } else {
    ...
    function reloadListObjectShare(objectCodeShared, objectTypeShared, objectCode, objectType, fileCode) {
        dataserviceRPT.getListObjectShare(objectCodeShared, objectTypeShared, objectCode, objectType, fileCode, function (rs) {
            rs = rs.data;
...
app.controller('tabFileHistory', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRPT, $filter, para) {
    var vm = $scope;
    $scope.selected = [];
    $scope.selectAll = false;
    $scope.toggleAll = toggleAll;
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/AssetRPTBroken/JTableFileHistory",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
    ...
    $scope.search = function () {
        var modalInstance = $uibModal.open({
            templateUrl: ctxfolderRPT + '/contractTabFileSearch.html',
            windowClass: 'modal-file',
            backdrop: 'static',
            controller: function ($scope, $uibModalInstance) {
                $scope.cancel = function () {
    ...
    $scope.add = function () {
        if ($scope.file == '' || $scope.file == undefined) {
            ...
            data.append("IsMore", false);
            dataserviceRPT.insertContractFile(data, function (result) {
                result = result.data;
                if (result.Error) {
                    App.toastrError(result.Title);
                } else {
    ...
    $scope.edit = function (fileName, id) {
        dataserviceRPT.getContractFile(id, function (rs) {
            rs = rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            }
                ...
                var modalInstance = $uibModal.open({
                    animation: true,
                    templateUrl: ctxfolderRPT + '/tabFileEdit.html',
    ...
    $scope.viewFile = function (id) {
        //dataserviceRPT.getByteFile(id, function (rs) {rs=rs.data;
        //    
        //    var blob = new Blob([rs.Object], { type: "application/msword;charset=utf-8" });
        //    var blobUrl = URL.createObjectURL(blob);
        //    var url = window.encodeURIComponent(blobUrl);
    ...
    $scope.extend = function (id) {
        dataserviceRPT.getSuggestionsContractFile($rootScope.RequestCode, function (rs) {
            rs = rs.data;
            var data = rs != '' ? rs : {};
            var modalInstance = $uibModal.open({
                templateUrl: ctxfolderRPT + '/tabFileAdd.html',
    ...
    $scope.getObjectFile = function (id, mode) {
        dataserviceRPT.getItemFile(id, true, mode);
    };
