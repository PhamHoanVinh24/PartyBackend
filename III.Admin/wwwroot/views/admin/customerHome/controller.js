var ctxfolder = "/views/admin/customerHome";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        getCountCustomerTotal: function (callback) {
            $http.get('/Admin/Customer/GetCountCustomer').then(callback);
        }
    };
});
...
app.controller('index', function ($scope, $rootScope, $sce, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter, $translate) {
    dataservice.getCountCustomerTotal(function (rs) {
        rs = rs.data;
        $scope.all = rs.All;
            ...
            var chart = c3.generate({
                ...
                data: {
                    ...
                    names: {
                        ...
                        'active': caption.CHC_LBL_BEING_ACTIVE,
                        'deactive': caption.CHC_LBL_SHUT_DOWN,
                    }
                },
                axis: {
                    x: {
    ...
    $scope.switchDiv = function () {
        ...
        divMenuDigital = $('#menuCusHome');
        divChart = $('#chartCusHome');
