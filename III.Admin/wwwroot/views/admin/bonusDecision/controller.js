...
app.factory('dataserviceBonusDecision', function ($http) {
    ...
    return {
        getStatusAct: function (callback) {
            $http.post('/Admin/BonusDecision/GetStatusAct').then(callback);
        },
        ...
        getUserDepartment: function (data, callback) {
            $http.get('/Admin/BonusDecision/GetUserDepartment?code=' + data).then(callback);
        },
        ...
        getListPayScaleDetail: function (data1, data2, callback) {
            $http.get('/Admin/BonusDecision/GetListPayScaleDetail?career=' + data1 + '&code=' + data2).then(callback);
        },
        getPaySalary: function (data1, data2, data3, callback) {
            $http.get('/Admin/BonusDecision/GetPaySalary?career=' + data1 + '&code=' + data2 + '&ranges=' + data3).then(callback);
        },
        getListPayScale: function (callback) {
            $http.get('/Admin/BonusDecision/GetListPayScale').then(callback);
        },
        getListCareer: function (callback) {
            $http.get('/Admin/BonusDecision/GetListCareer').then(callback);
        },
        getWorkFlow: function (callback) {
            $http.post('/Admin/BonusDecision/GetWorkFlow').then(callback);
        },
        getListPayTitle: function (callback) {
            $http.post('/Admin/BonusDecision/GetListPayTitle').then(callback);
        },
        getItemHeader: function (data, callback) {
            $http.post('/Admin/BonusDecision/GetItemHeader?id=' + data).then(callback);
        },
        getItemHeaderWithCode: function (data, callback) {
            $http.post('/Admin/BonusDecision/GetItemHeaderWithCode?code=' + data).then(callback);
        },
        getListRepeat: function (data, callback) {
            $http.post('/Admin/BonusDecision/GetListRepeat?code=' + data).then(callback);
        },
        getUserDetail: function (data, callback) {
            $http.get('/Admin/BonusDecision/GetUserDetail?code=' + data).then(callback);
        },
        getStepWorkFlow: function (data, callback) {
            $http.post('/Admin/BonusDecision/GetStepWorkFlow?code=' + data).then(callback);
        },
        getActionStatus: function (data, callback) {
            $http.get('/Admin/BonusDecision/GetActionStatus?code=' + data).then(callback);
        },
        getListActivityRepeat: function (data, callback) {
            $http.get('/Admin/BonusDecision/GetListActivityRepeat?decisionNum=' + data).then(callback);
        },
        getStatusDe: function (callback) {
            $http.post('/Admin/BonusDecision/GetStatusDe').then(callback);
        },
        getliSigner: function (callback) {
            $http.get('/Admin/BonusDecision/GetliSigner').then(callback);
        },
        getlistDecision: function (callback) {
            $http.get('/Admin/BonusDecision/GetlistDecision').then(callback);
        },
        //Header
        insert: function (data, callback) {
            $http.post('/Admin/BonusDecision/Insert', data).then(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/BonusDecision/Update', data).then(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/BonusDecision/Delete', data).then(callback);
        },

        //Detail
        insertDetail: function (data, callback) {
            $http.post('/Admin/BonusDecision/InsertDetail', data).then(callback);
        },
        deleteDetail: function (data, callback) {
            $http.post('/Admin/BonusDecision/DeleteDetail', data).then(callback);
        },
        updateDetailEmployee: function (data, callback) {
            $http.post('/Admin/BonusDecision/UpdateDetailEmployee?code=' + data).then(callback);
        },
        ...
        getJsonData: function (data, callback) {
            $http.post('/Admin/BonusDecision/GetJsonData?decisionNum=' + data).then(callback);
        },
        //excel
        //ExportExcel
        exportExcel: function (data, callback) {
            $http.post('/Admin/BonusDecision/ExportExcel?planNumber=' + data).then(callback);
        },
        uploadFile: function (data, callback) {
            submitFormUpload('/Admin/BonusDecision/UploadFile', data, callback)
        },
        checkData: function (data, callback) {
            $http.post('/Admin/BonusDecision/CheckData', data).then(callback);
        },
        logInfomation: function (data, callback) {
            $http.post('/Admin/BonusDecision/LogInfomation', data).then(callback);
        },
        insertFromExcel: function (data, callback) {
            $http.post('/Admin/BonusDecision/InsertFromExcel', data).then(callback);
        },
    };
});
...
app.controller('Ctrl_ESEIM_BONUS_DECISION', function ($scope, $rootScope, $cookies, $filter, dataserviceBonusDecision, $translate) {
...
app.config(function ($routeProvider, $validatorProvider, $translateProvider, $httpProvider) {
    ...
    $routeProvider
        .when('/', {
            templateUrl: ctxfolderBonusDecision + '/index.html',
            controller: 'index'
        })
        .when('/add', {
            templateUrl: ctxfolderBonusDecision + '/add.html',
            controller: 'add',
        })
        .when('/edit', {
            templateUrl: ctxfolderBonusDecision + '/edit.html',
            controller: 'edit',
        })
...
app.controller('index', function ($scope, $rootScope, $compile, $confirm, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceBonusDecision, $location, $filter, myService) {
    var vm = $scope;
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/BonusDecision/JTable",
    ...
    $scope.init = function () {
        ...
        dataserviceBonusDecision.getliSigner(function (rs) {
            rs = rs.data;
            $scope.LstSiger = rs;
        })
        dataserviceBonusDecision.getStatusDe(function (rs) {
            rs = rs.data;
            $scope.listStatusDecision = rs;
        });
        dataserviceBonusDecision.getlistDecision(function (rs) {
            rs = rs.data;
    ...
    $scope.edit = function (id) {
        dataserviceBonusDecision.getItemHeader(id, function (rs) {
            rs = rs.data;
            rs.page = "edit";
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                $scope.ok = function () {
                    dataserviceBonusDecision.delete(id, function (rs) {
                        rs = rs.data;
                        if (rs.Error) {
...
app.controller('add', function ($scope, $route, $location, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceBonusDecision, $filter, myService) {
    var vm = $scope;
    //wflow
    $rootScope.modelWf = {
        WorkflowCode: "",
        ObjectType: "BONUS_DECISION",
        ObjectInst: "",
    };
    $scope.selected = [];
    $scope.selectAll = false;
    ...
    $scope.export = function () {
        ...
        if ($scope.modelHeader.DecisionNum != "" && $scope.modelHeader.DecisionNum != null && $scope.modelHeader.DecisionNum != undefined) {
            location.href = "/Admin/BonusDecision/ExportReport?"
    ...
    if (myService.getData() != undefined && myService.getData() != "" && myService.getData() != null) {
        ...
        if (data.data != undefined && data.data != "" && data.data != null) {
            ...
            if (data.page == "add") {
                ...
                $scope.modelHeader.WorkflowCat = 'BONUS_DECISION';
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/BonusDecision/JTableDetail",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('EmployeeName').withTitle('{{"ECD_LIST_COL_FULL_NAME" | translate}}').renderWith(function (data, type) {
        return '<p class="text-green bold" >' + data + '</p>';
    }).withOption('sClass', 'dataTable-pr0'));
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Money').withTitle('{{"ECD_LBL_CRUD_MONEY" | translate}}').renderWith(function (data, type) {
        return data;
    }).withOption('sClass', 'dataTable-pr0'));
    ...
    $scope.init = function () {
        dataserviceBonusDecision.getWorkFlow(function (result) {
            result = result.data;
            $rootScope.lstWorkflow = result;
        });
        dataserviceBonusDecision.gettreedataunit(function (result) {
            result = result.data;
        ...
        if ($scope.check == true) {
            dataserviceBonusDecision.getStatusAct(function (rs) {
                rs = rs.data;
                $scope.lstStatusAct = rs;
            })
        }
        dataserviceBonusDecision.getListPayScale(function (rs) {
            rs = rs.data;
            $scope.lstPayScale = rs;
        })
        dataserviceBonusDecision.getListCareer(function (rs) {
            rs = rs.data;
            $scope.lstCareer = rs;
        })
        dataserviceBonusDecision.getListPayTitle(function (rs) {
            rs = rs.data;
    ...
    $scope.changUser = function () {
        dataserviceBonusDecision.getUserDetail($scope.model.UserinDepart, function (rs) {
            rs = rs.data;
            ...
            dataserviceBonusDecision.getListPayScaleDetail($scope.model.Career, $scope.model.PayScale, function (rs) {
                rs = rs.data;
                $scope.lstRange = rs;
            })
            dataserviceBonusDecision.getPaySalary($scope.model.Career, $scope.model.PayScale, $scope.model.PayRanges, function (rs) {
                rs = rs.data;
    ...
    $scope.changePayScale = function (data1, data2) {
        dataserviceBonusDecision.getListPayScaleDetail(data1, data2, function (rs) {
            rs = rs.data;
            $scope.lstRange = rs;
        })
        dataserviceBonusDecision.getPaySalary(data1, data2, model.PayRanges, function (rs) {
            rs = rs.data;
            $scope.model.Salary = rs;
        })
    }
    $scope.changePayRanges = function (data1, data2, data3) {
        dataserviceBonusDecision.getPaySalary(data1, data2, data3, function (rs) {
            rs = rs.data;
            $scope.model.Salary = rs;
        })
    }
    $scope.changeStatus = function () {
        if ($scope.modelHeader.Status == "REPEAT_REQUIRE_REWORK" || $scope.modelHeader.Status == "FINAL_REQUIRE_REWORK") {
            /* dataserviceBonusDecision.getListActivityRepeat($scope.modelHeader.DecisionNum, function (rs) {
                 rs = rs.data;
                 $scope.lstActRepeat = rs;
                 $scope.showAct = true;
             })*/

            dataserviceBonusDecision.getListRepeat($scope.modelHeader.DecisionNum, function (rs) {
                rs = rs.data;
                var arr = [];
    ...
    $scope.changeSelect = function (type) {
        switch (type) {
            case 'Unit':
                ...
                dataserviceBonusDecision.getUserDepartment($scope.model.Unit, function (rs) {
                    rs = rs.data;
    ...
    $scope.edit = function () {
        ...
        $scope.onlyedit = true;
        $scope.reload();
        dataserviceBonusDecision.getItemHeaderWithCode($scope.modelHeader.DecisionNum, function (rs) {
            data = rs.data;
    ...
    $scope.addHeader = function () {
        if ($scope.modelHeader.Status != "STATUS_ACTIVITY_DO") {
            ...
            if ($scope.addform.validate() && !validationSelect($scope.modelHeader).Status) {
                ...
                dataserviceBonusDecision.createWfInstance($scope.modelWf, function (rs) {
                    rs = rs.data;
                    if (rs.Error) {
                        App.toastrError(rs.Title);
                    } else {
                        ...
                        //dataserviceBonusDecision.insertInstRunning(wfInstCode, $scope.modelWf.WorkflowCode, function (rs) {

                        //})

                        dataserviceBonusDecision.insert($scope.modelHeader, function (rs) {
                            rs = rs.data;
                            if (rs.Error) {
                                App.toastrError(rs.Title);
                            } else {
                                ...
                                dataserviceBonusDecision.getActionStatus($scope.modelHeader.DecisionNum, function (rs) {
                                    rs = rs.data;
    ...
    $scope.editHeader = function () {
        if ($scope.roleedit == true) {
            validationSelect($scope.modelHeader);
            if ($scope.addform.validate() && !validationSelect($scope.modelHeader).Status) {
                dataserviceBonusDecision.update($scope.modelHeader, function (rs) {
                    rs = rs.data;
                    if (rs.Error) {
                        App.toastrError(rs.Title);
                    } else {
                        if ($scope.modelHeader.Status != "STATUS_ACTIVITY_APPROVE_END") {
                            ...
                            dataserviceBonusDecision.updateDetailEmployee($scope.modelHeader.DecisionNum, function (rs) {
                                rs = rs.data;
                                if (rs.Error) {
                                    App.toastrError(rs.Title);
                                }
    ...
    $scope.addDetail = function () {
        ...
        if (!validationSelectDetail($scope.model).Status) {
            ...
            dataserviceBonusDecision.insertDetail($scope.model, function (rs) {
                rs = rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                } else {
    ...
    $scope.removeDetail = function () {
        if ($rootScope.selectedItems != "" && $rootScope.selectedItems != undefined && $rootScope.selectedItems != null) {
            ...
            if (arr.length > 0) {
                dataserviceBonusDecision.deleteDetail(arr, function (rs) {
                    rs = rs.data;
                    if (rs.Error) {
                        App.toastrError(rs.Title);
                    } else {
    ...
    $scope.showLog = function () {
        dataserviceBonusDecision.getJsonData($scope.modelHeader.DecisionNum, function (rs) {
            rs = rs.data;
            var modalInstance = $uibModal.open({
                animation: true,
    ...
    $scope.editInstAct = function (id, objCode) {
        dataserviceBonusDecision.checkPermissionEditActivityById(id, function (rs) {
            rs = rs.data;
            if (!rs) {
                return App.toastrError(caption.COM_MSG_PERMISSION_EDIT_ACT);
            }
            dataserviceBonusDecision.getItemActInst(id, function (rs) {
    ...
    $scope.importExcel = function () {
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: ctxfolderBonusDecision + '/excel.html',
            controller: 'excel',
            backdrop: 'static',
            size: '80',
            resolve: {
...
app.controller('excel', function ($scope, $rootScope, $compile, $uibModal, $location, $filter, $uibModalInstance, dataserviceBonusDecision, $timeout, para) {
    $scope.cancel = function () {
        $uibModalInstance.close();
    }
    $scope.IsEdit = false;
    ...
    $scope.changeUnit = function (data) {
        ...
        dataserviceBonusDecision.getUserDepartment(data, function (rs) {
            rs = rs.data;
            $scope.lstUserinDpt = rs;
        })
    }
    $scope.changUser = function (data) {
        dataserviceBonusDecision.getUserDetail(data, function (rs) {
            rs = rs.data;
            $scope.model.PayScaleCode = rs[0].PayScale;
            $scope.model.PayRanges = rs[0].PayRanges;
            $scope.model.CareerCode = rs[0].Career;
            $scope.model.CareerTitle = rs[0].ChucDanh;
            dataserviceBonusDecision.getListPayScaleDetail($scope.model.CareerCode, $scope.model.PayScaleCode, function (rs) {
                rs = rs.data;
                $scope.lstRange = rs;
            })
            dataserviceBonusDecision.getPaySalary($scope.model.CareerCode, $scope.model.PayScaleCode, $scope.model.PayRanges, function (rs) {
                rs = rs.data;
                $scope.model.Salary = rs;
            })
        })
    ...
    $scope.changePayScale = function (data1, data2) {
        ...
        dataserviceBonusDecision.getPaySalary(data1, data2, $scope.model.PayRanges, function (rs) {
            rs = rs.data;
            $scope.model.Salary = rs;
        })
    }
    ...
    $scope.checkloop = function () {
        ...
        dataserviceBonusDecision.checkData({
    ...
    $scope.uploadFile = function () {
        ...
        if (file == null || file == undefined || file == "") {
            ...
            dataserviceBonusDecision.uploadFile(form, function (rs) {
                rs = rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                }
    ...
    $scope.submitEdit = function () {
        $scope.lstModel = [];
        dataserviceBonusDecision.logInfomation($scope.model, function (rs) {
            rs = rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
                    ...
                    if (rs.Error) {
                        ...
                        dataserviceBonusDecision.insert($scope.modelHeader, function (rs) {
                            ...
                            if (rs.Error) {
                                ...
                                dataserviceBonusDecision.insertFromExcel({ ListEmp: $scope.Listdata }, function (rs) {
                                    rs = rs.data;
                                    if (rs.Error) {
                                        App.toastrError(rs.Title);
                                    } else {
