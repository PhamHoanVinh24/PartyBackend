...
app.factory('dataservicePayDecision', function ($http) {
    ...
    return {
        ...
        getUserDepartment: function (data, callback) {
            $http.get('/Admin/PayDecision/GetUserDepartment?code=' + data).then(callback);
        },
        ...
        getListPayScaleDetail: function (data1, data2, callback) {
            $http.get('/Admin/PayDecision/GetListPayScaleDetail?career=' + data1 + '&code=' + data2).then(callback);
        },
        getPaySalary: function (data1, data2, data3, callback) {
            $http.get('/Admin/PayDecision/GetPaySalary?career=' + data1 + '&code=' + data2 + '&ranges=' + data3).then(callback);
        },
        getListPayScale: function (callback) {
            $http.get('/Admin/PayDecision/GetListPayScale').then(callback);
        },
        getListCareer: function (callback) {
            $http.get('/Admin/PayDecision/GetListCareer').then(callback);
        },
        getWorkFlow: function (callback) {
            $http.post('/Admin/PayDecision/GetWorkFlow').then(callback);
        },
        getListPayTitle: function (callback) {
            $http.post('/Admin/PayDecision/GetListPayTitle').then(callback);
        },
        getItemHeader: function (data, callback) {
            $http.post('/Admin/PayDecision/GetItemHeader?id=' + data).then(callback);
        },
        getItemHeaderWithCode: function (data, callback) {
            $http.post('/Admin/PayDecision/GetItemHeaderWithCode?code=' + data).then(callback);
        },
        getListRepeat: function (data, callback) {
            $http.post('/Admin/PayDecision/GetListRepeat?code=' + data).then(callback);
        },
        getUserDetail: function (data, callback) {
            $http.get('/Admin/PayDecision/GetUserDetail?code=' + data).then(callback);
        },
        ...
        getActionStatus: function (data, callback) {
            $http.get('/Admin/PayDecision/GetActionStatus?code=' + data).then(callback);
        },
        getListActivityRepeat: function (data, callback) {
            $http.get('/Admin/PayDecision/GetListActivityRepeat?decisionNum=' + data).then(callback);
        },
        getStatusDe: function (callback) {
            $http.post('/Admin/PayDecision/GetStatusDe').then(callback);
        },
        getliSigner: function (callback) {
            $http.get('/Admin/PayDecision/GetliSigner').then(callback);
        },
        getlistDecision: function (callback) {
            $http.get('/Admin/PayDecision/GetlistDecision').then(callback);
        },
        //Header
        insert: function (data, callback) {
            $http.post('/Admin/PayDecision/Insert', data).then(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/PayDecision/Update', data).then(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/PayDecision/Delete', data).then(callback);
        },

        //Detail
        insertDetail: function (data, callback) {
            $http.post('/Admin/PayDecision/InsertDetail', data).then(callback);
        },
        deleteDetail: function (data, callback) {
            $http.post('/Admin/PayDecision/DeleteDetail', data).then(callback);
        },
        updateDetailEmployee: function (data, callback) {
            $http.post('/Admin/PayDecision/UpdateDetailEmployee?code=' + data).then(callback);
        },
        ...
        getJsonData: function (data, callback) {
            $http.post('/Admin/PayDecision/GetJsonData?decisionNum=' + data).then(callback);
        },
        //excel
        //ExportExcel
        exportExcel: function (data, callback) {
            $http.post('/Admin/PayDecision/ExportExcel?planNumber=' + data).then(callback);
        },
        uploadFile: function (data, callback) {
            submitFormUpload('/Admin/PayDecision/UploadFile', data, callback)
        },
        checkData: function (data, callback) {
            $http.post('/Admin/PayDecision/CheckData', data).then(callback);
        },
        logInfomation: function (data, callback) {
            $http.post('/Admin/PayDecision/LogInfomation', data).then(callback);
        },
        insertFromExcel: function (data, callback) {
            $http.post('/Admin/PayDecision/InsertFromExcel', data).then(callback);
        },
    };
});
...
app.controller('Ctrl_ESEIM_PAY_DECISION', function ($scope, $rootScope, $cookies, $filter, dataservicePayDecision, $translate) {
    ...
    $rootScope.$on('$translateChangeSuccess', function () {
        ...
        $rootScope.validationOptionsPay = {
            rules: {
                DecisionNum: {
                    required: true,
...
app.config(function ($routeProvider, $validatorProvider, $translateProvider, $httpProvider) {
    $translateProvider.useUrlLoader('/Admin/PayDecision/Translation');
    caption = $translateProvider.translations();
    $routeProvider
        .when('/', {
            templateUrl: ctxfolderPayDecision + '/index.html',
            controller: 'index'
        })
        .when('/add', {
            templateUrl: ctxfolderPayDecision + '/add.html',
            controller: 'add',
        })
        .when('/edit', {
            templateUrl: ctxfolderPayDecision + '/edit.html',
            controller: 'edit',
        })
...
app.controller('index', function ($scope, $rootScope, $compile, $confirm, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservicePayDecision, $location, $filter, myService) {
    var vm = $scope;
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Full').withTitle('{{"PDC_CRUD_NUM_DEC"| translate}} & {{"PDC_VALIDATE_NAME"| translate}}').renderWith(function (data, type) {
        return data;
    }).withOption('sClass', 'dataTable-pr0 dataTable-20per bold'));
    vm.dtColumns.push(DTColumnBuilder.newColumn('CreatedTime').withTitle('{{"PDC_LIST_COL_DATE_DECISTION" | translate}}').renderWith(function (data, type) {
        return data != "" ? $filter('date')(new Date(data), 'dd/MM/yyyy') : null;
    }).withOption('sClass', 'dataTable-pr0 dataTable-20per'));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Status').withTitle('{{"PDC_LIST_COL_STATUS" | translate}}').renderWith(function (data, type) {
        return data;
    }).withOption('sClass', 'dataTable-pr0 dataTable-20per'));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Signer').withTitle('{{"PDC_SEARCH_SIGNER_BT" | translate}}').renderWith(function (data, type) {
        return data;
    }).withOption('sClass', 'tcenter dataTable-pr0 dataTable-15per'));
    vm.dtColumns.push(DTColumnBuilder.newColumn('SignTime').withTitle('{{"PDC_LIST_COL_DATE_SIGN" | translate}}').renderWith(function (data, type) {
        return data;
    }).withOption('sClass', 'dataTable-pr0 dataTable-15per'));
    vm.dtColumns.push(DTColumnBuilder.newColumn('action').notSortable().withTitle('{{"PDC_MANIPULATION" | translate}}').withOption('sClass', 'nowrap text-center dataTable-w80').renderWith(function (data, type, full) {
    ...
    $scope.init = function () {
        ...
        dataservicePayDecision.getliSigner(function (rs) {
            rs = rs.data;
            $scope.LstSiger = rs;
        })
        dataservicePayDecision.getStatusDe(function (rs) {
            rs = rs.data;
            $scope.listStatusDecision = rs;
        });
        dataservicePayDecision.getlistDecision(function (rs) {
            rs = rs.data;
    ...
    $scope.edit = function (id) {
        dataservicePayDecision.getItemHeader(id, function (rs) {
            rs = rs.data;
            rs.page = "edit";
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                $scope.ok = function () {
                    dataservicePayDecision.delete(id, function (rs) {
                        rs = rs.data;
                        if (rs.Error) {
...
app.controller('add', function ($scope, $route, $location, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservicePayDecision, $filter, myService) {
    var vm = $scope;
    //wflow
    $rootScope.modelWf = {
        WorkflowCode: "",
        ObjectType: "PAY_DECISION",
        ObjectInst: "",
    };
    $scope.selected = [];
    $scope.selectAll = false;
    ...
    $scope.export = function () {
        if ($scope.modelHeader.DecisionNum != "" && $scope.modelHeader.DecisionNum != null && $scope.modelHeader.DecisionNum != undefined) {
            location.href = "/Admin/PayDecision/ExportReport?"
    ...
    if (myService.getData() != undefined && myService.getData() != "" && myService.getData() != null) {
        ...
        if (data.data != undefined && data.data != "" && data.data != null) {
            ...
            if (data.page == "add") {
                ...
                $scope.modelHeader.WorkflowCat = 'PAY_DECISION';
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/PayDecision/JTableDetail",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
    ...
    vm.dtColumns = [];
    vm.dtColumns.push(DTColumnBuilder.newColumn('CodeName').withTitle('Mã thẻ').renderWith(function (data, type) {
        return '<p class="text-green bold" >' + data + '</p>';
        /*'<span class="">' + $scope.unit + '</span>';*/
    }).withOption('sClass', 'dataTable-pr0 dataTable-15per'));
    vm.dtColumns.push(DTColumnBuilder.newColumn('UserName').withTitle('Họ và Tên').renderWith(function (data, type) {
        return '<p class="text-green bold" >' + data + '</p>';
        /*'<span class="">' + $scope.unit + '</span>';*/
    }).withOption('sClass', 'dataTable-pr0 dataTable-15per'));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Position').withTitle('Đơn vị').renderWith(function (data, type) {
        return data;
    }).withOption('sClass', 'dataTable-pr0 dataTable-20per'));
    vm.dtColumns.push(DTColumnBuilder.newColumn('CareerCode').withTitle('Nghề nghiệp').renderWith(function (data, type) {
        return data;
    }).withOption('sClass', 'dataTable-pr0 dataTable-15per'));
    vm.dtColumns.push(DTColumnBuilder.newColumn('TitleName').withTitle('Chức danh').renderWith(function (data, type) {
        return data;
    }).withOption('sClass', 'dataTable-pr0 dataTable-15per'));
    vm.dtColumns.push(DTColumnBuilder.newColumn('PayScale').withTitle('Thang lương').renderWith(function (data, type) {
        return data;
    }).withOption('sClass', 'dataTable-pr0 dataTable-15per'));
    vm.dtColumns.push(DTColumnBuilder.newColumn('PayRange').withTitle('Bậc lương').renderWith(function (data, type) {
        return data;
    }).withOption('sClass', 'tcenter dataTable-pr0 dataTable-15per'));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Salary').withTitle('Mức lương').renderWith(function (data, type) {
        return '<span class="text-danger">' + $filter('currency')(data, '', 0) + '</span>';
    }).withOption('sClass', 'tcenter dataTable-pr0 dataTable-15per'));
    vm.dtColumns.push(DTColumnBuilder.newColumn("Id").withTitle("Xóa").notSortable().renderWith(function (data, type, full, meta) {
        $scope.selected[full.Id] = false;
        return '<label class="mt-checkbox"><input type="checkbox" ng-model="selected[' + full.Id + ']" ng-click="toggleOne(selected)"/><span></span></label>';
    ...
    $scope.init = function () {
        dataservicePayDecision.getWorkFlow(function (result) {
            result = result.data;
            $rootScope.lstWorkflow = result;
        });
        dataservicePayDecision.gettreedataunit(function (result) {
            result = result.data;
        ...
        if ($scope.check == true) {
            dataservicePayDecision.getStatusAct(function (rs) {
                rs = rs.data;
                $scope.lstStatusAct = rs;
            })
        }
        dataservicePayDecision.getListPayScale(function (rs) {
            rs = rs.data;
            $scope.lstPayScale = rs;
        })
        dataservicePayDecision.getListCareer(function (rs) {
            rs = rs.data;
            $scope.lstCareer = rs;
        })
        dataservicePayDecision.getListPayTitle(function (rs) {
            rs = rs.data;
    ...
    $scope.changeUnit = function (data) {
        ...
        dataservicePayDecision.getUserDepartment(data, function (rs) {
            rs = rs.data;
            $scope.lstUserinDpt = rs;
        })
    }
    $scope.changUser = function () {
        dataservicePayDecision.getUserDetail($scope.model.UserinDepart, function (rs) {
            rs = rs.data;
            ...
            dataservicePayDecision.getListPayScaleDetail($scope.model.Career, $scope.model.PayScale, function (rs) {
                rs = rs.data;
                $scope.lstRange = rs;
            })
            dataservicePayDecision.getPaySalary($scope.model.Career, $scope.model.PayScale, $scope.model.PayRanges, function (rs) {
                rs = rs.data;
    ...
    $scope.changePayScale = function (data1, data2) {
        dataservicePayDecision.getListPayScaleDetail(data1, data2, function (rs) {
            rs = rs.data;
            $scope.lstRange = rs;
        })
        dataservicePayDecision.getPaySalary(data1, data2, $scope.model.PayRanges, function (rs) {
            rs = rs.data;
            $scope.model.Salary = rs;
        })
    }
    $scope.changePayRanges = function (data1, data2, data3) {
        dataservicePayDecision.getPaySalary(data1, data2, data3, function (rs) {
            rs = rs.data;
            $scope.model.Salary = rs;
        })
    }
    $scope.changeStatus = function () {
        if ($scope.modelHeader.Status == "REPEAT_REQUIRE_REWORK" || $scope.modelHeader.Status == "FINAL_REQUIRE_REWORK") {
            /* dataservicePayDecision.getListActivityRepeat($scope.modelHeader.DecisionNum, function (rs) {
                 rs = rs.data;
                 $scope.lstActRepeat = rs;
                 $scope.showAct = true;
             })*/

            dataservicePayDecision.getListRepeat($scope.modelHeader.DecisionNum, function (rs) {
                rs = rs.data;
                var arr = [];
    ...
    $scope.edit = function () {
        ...
        $scope.onlyedit = true;
        $scope.reload();
        dataservicePayDecision.getItemHeaderWithCode($scope.modelHeader.DecisionNum, function (rs) {
            data = rs.data;
    ...
    $scope.addHeader = function () {
        if ($scope.modelHeader.Status != "STATUS_ACTIVITY_DO") {
            ...
            if ($scope.addform.validate() && !validationSelect($scope.model).Status) {
                ...
                dataservicePayDecision.createWfInstance($scope.modelWf, function (rs) {
                    rs = rs.data;
                    if (rs.Error) {
                        App.toastrError(rs.Title);
                    } else {
                        ...
                        //dataservicePayDecision.insertInstRunning(wfInstCode, $scope.modelWf.WorkflowCode, function (rs) {

                        //})

                        dataservicePayDecision.insert($scope.modelHeader, function (rs) {
                            rs = rs.data;
                            if (rs.Error) {
                                App.toastrError(rs.Title);
                            } else {
                                ...
                                dataservicePayDecision.getActionStatus($scope.modelHeader.DecisionNum, function (rs) {
                                    rs = rs.data;
    ...
    $scope.editHeader = function () {
        if ($scope.roleedit == true) {
            validationSelect($scope.modelHeader);
            if ($scope.addformPay.validate() && !validationSelect($scope.model).Status) {
                dataservicePayDecision.update($scope.modelHeader, function (rs) {
                    rs = rs.data;
                    if (rs.Error) {
                        App.toastrError(rs.Title);
                    } else {
                        if ($scope.modelHeader.Status != "STATUS_ACTIVITY_APPROVE_END") {
                            ...
                            dataservicePayDecision.updateDetailEmployee($scope.modelHeader.DecisionNum, function (rs) {
                                rs = rs.data;
                                if (rs.Error) {
                                    App.toastrError(rs.Title);
                                }
    ...
    $scope.addDetail = function () {
        ...
        if (!validationSelectDetail($scope.model).Status) {
            ...
            dataservicePayDecision.insertDetail($scope.model, function (rs) {
                rs = rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                } else {
    ...
    $scope.removeDetail = function () {
        if ($rootScope.selectedItems != "" && $rootScope.selectedItems != undefined && $rootScope.selectedItems != null) {
            ...
            if (arr.length > 0) {
                dataservicePayDecision.deleteDetail(arr, function (rs) {
                    rs = rs.data;
                    if (rs.Error) {
                        App.toastrError(rs.Title);
                    } else {
    ...
    $scope.showLog = function () {
        dataservicePayDecision.getJsonData($scope.modelHeader.DecisionNum, function (rs) {
            rs = rs.data;
            var modalInstance = $uibModal.open({
                animation: true,
    ...
    $scope.editInstAct = function (id, objCode) {
        dataservicePayDecision.checkPermissionEditActivityById(id, function (rs) {
            rs = rs.data;
            if (!rs) {
                return App.toastrError(caption.COM_MSG_PERMISSION_EDIT_ACT);
            }
            dataservicePayDecision.getItemActInst(id, function (rs) {
    ...
    $scope.importExcel = function () {
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: ctxfolderPayDecision + '/excel.html',
            controller: 'excel',
            backdrop: 'static',
            size: '80',
            resolve: {
...
app.controller('excel', function ($scope, $rootScope, $compile, $uibModal, $location, $filter, $uibModalInstance, dataservicePayDecision, $timeout, para) {
    $scope.cancel = function () {
        $uibModalInstance.close();
    }
    $scope.IsEdit = false;
    ...
    $scope.changUser = function (data) {
        dataservicePayDecision.getUserDetail(data, function (rs) {
            rs = rs.data;
            $scope.model.PayScaleCode = rs[0].PayScale;
            $scope.model.PayRanges = rs[0].PayRanges;
            $scope.model.CareerCode = rs[0].Career;
            $scope.model.CareerTitle = rs[0].ChucDanh;
            dataservicePayDecision.getListPayScaleDetail($scope.model.CareerCode, $scope.model.PayScaleCode, function (rs) {
                rs = rs.data;
                $scope.lstRange = rs;
            })
            dataservicePayDecision.getPaySalary($scope.model.CareerCode, $scope.model.PayScaleCode, $scope.model.PayRanges, function (rs) {
                rs = rs.data;
                $scope.model.Salary = rs;
            })
        })
    ...
    $scope.checkloop = function () {
        ...
        dataservicePayDecision.checkData({
    ...
    $scope.uploadFile = function () {
        ...
        if (file == null || file == undefined || file == "") {
            ...
            dataservicePayDecision.uploadFile(form, function (rs) {
                rs = rs.data;
                if (rs.Error) {
                    App.toastrError(rs.Title);
                }
    ...
    $scope.submitEdit = function () {
        $scope.lstModel = [];
        dataservicePayDecision.logInfomation($scope.model, function (rs) {
            rs = rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
                    ...
                    if (rs.Error) {
                        ...
                        dataservicePayDecision.insert($scope.modelHeader, function (rs) {
                            ...
                            if (rs.Error) {
                                ...
                                dataservicePayDecision.insertFromExcel({ ListEmp: $scope.Listdata }, function (rs) {
                                    rs = rs.data;
                                    if (rs.Error) {
                                        App.toastrError(rs.Title);
                                    } else {
