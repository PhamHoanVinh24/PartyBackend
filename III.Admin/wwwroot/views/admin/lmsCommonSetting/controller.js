var ctxfolder = "/views/admin/lmsCommonSetting";
var ctxfolderMessage = "/views/message-box";

var app = angular.module('App_ESEIM', ["ui.bootstrap", "ngRoute", "ngValidate", "datatables", "datatables.bootstrap", 'datatables.colvis', "ui.bootstrap.contextMenu", 'datatables.colreorder', 'angular-confirm', "ngJsTree", "treeGrid", "ui.select", "ngCookies", "pascalprecht.translate", 'ui.tab.scroll']);
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        insertNew: function (data, callback) {
            $http.post('/Admin/LmsCommonSetting/InsertNew/', data).then(callback);
        },
        ...
        updateAll: function (data, callback) {
            $http.post('/Admin/LmsCommonSetting/UpdateAll/', data).then(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/LmsCommonSetting/Delete', data).then(callback);
        },
...
app.config(function ($routeProvider, $validatorProvider, $translateProvider) {
    $translateProvider.useUrlLoader('/Admin/LmsCommonSetting/Translation');
...
app.controller('total', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/LmsCommonSetting/JTable/",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
    ...
    vm.dtColumns = [];
    vm.dtColumns.push(DTColumnBuilder.newColumn('Id').withTitle('{{"COM_SET_LIST_COL_ORDER" | translate}}').notSortable().withOption('sWidth', '30px').withOption('sClass', 'tcenter w50').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('AttrCode').withTitle('{{"LMS_COM_LBL_CODE" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('AttrName').withTitle('{{"LMS_COM_LBL_CODE_NAME" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('AttrNote').withTitle('{{"LMS_COM_LBL_DETAIL" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Group').withTitle('{{"LMS_COM_LBL_GROUP" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Type').withTitle('{{"LMS_COM_LBL_TYPE_NAME_DATA" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('DataType').withTitle('{{"LMS_COM_LBL_TYPE_DATA" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Flag').withTitle('{{"LMS_COM_LBL_FLAG" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Order').withTitle('{{"LMS_COM_LBL_SORT" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('CreatedTime').withTitle('{{"COM_SET_LIST_COL_CREATE_TIME" | translate}}').renderWith(function (data, type) {
        return data != "" ? $filter('date')(new Date(data), 'dd/MM/yyyy') : null;
...
app.controller('add', function ($scope, $rootScope, $confirm, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter) {
    ...
    $scope.listDataType = [
        { Code: 'TEXT', Name: caption.LMS_COM_LBL_STRING },
        { Code: 'NUMBER', Name: caption.LMS_COM_LBL_NUMBER },
        { Code: 'MONEY', Name: caption.LMS_COM_LBL_MONEY },
        { Code: 'DATETIME', Name: caption.LMS_COM_LBL_DATE_TIME }];
    $scope.flag = [
        { Code: 1, Name: caption.LMS_COM_LBL_DISPLAY },
        { Code: 2, Name: caption.LMS_COM_LBL_HIDE }];
    $scope.order = [
        { Code: 1, Name: caption.LMS_COM_LBL_NUMBER + '1' },
        { Code: 2, Name: caption.LMS_COM_LBL_NUMBER + '2'  }];
    $scope.group = [
        { Code: 1, Name: caption.LMS_COM_LBL_GROUP  + '1' },
        { Code: 2, Name: caption.LMS_COM_LBL_GROUP + '2' }];
    //$scope.init = function () {
...
app.controller('edit', function ($scope, $rootScope, $confirm, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter, para) {
    ...
    $scope.model = {
        Id: para.Id,
        AttrCode: para.AttrCode,
        AttrName: para.AttrName,
        AttrNote: para.AttrNote,
        Group: para.Group,
        Type: para.Type,
    ...
    $scope.listDataType = [
        ...
        { Code: 'DATETIME', Name: caption.LMS_COM_LBL_DATE_TIME }];
    $scope.flag = [
        { Code: '1', Name: caption.LMS_COM_LBL_HIDE },
        { Code: '2', Name: caption.LMS_COM_LBL_DISPLAY }];
    $scope.order = [
        { Code: '1', Name: caption.LMS_COM_LBL_NUMBER + '1' },
        { Code: '2', Name: caption.LMS_COM_LBL_NUMBER + '2' }];
    $scope.group = [
