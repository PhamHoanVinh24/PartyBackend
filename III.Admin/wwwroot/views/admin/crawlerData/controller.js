...
app.factory('dataserviceRepository', function ($http, /*$upload*/) {
    ...
    return {
        ...
        getTreeInNode: function (data, callback) {
            $http.post('/Admin/CrawlerData/GetTreeInNode?parentId=' + data).then(callback);
        },
        getParentCategory: function (data, callback) {
            $http.post('/Admin/CrawlerData/GetParentCategory', data).then(callback);
        },
        getItemCategory: function (data, callback) {
            $http.get('/Admin/CrawlerData/GetItemCategory?id=' + data).then(callback);
        },
        insertCategory: function (data, callback) {
            $http.post('/Admin/CrawlerData/InsertCategory', data).then(callback);
        },
        updateCategory: function (data, callback) {
            $http.post('/Admin/CrawlerData/UpdateCategory', data).then(callback);
        },
        deleteCategory: function (data, callback) {
            $http.post('/Admin/CrawlerData/DeleteCategory?catCode=' + data).then(callback);
        },

        //repository
        getTreeRepository: function (callback) {
            $http.post('/Admin/CrawlerData/GetTreeRepository').then(callback);
        },
        getGoogleApiTokens: function (callback) {
            $http.post('/Admin/CrawlerData/GetGoogleApiTokens').then(callback);
        },
        getItemRepository: function (data, callback) {
            $http.get('/Admin/CrawlerData/GetItemRepository?reposCode=' + data, {
                beforeSend: function () {
                    App.blockUI({
                        target: "#contentMain",
                        boxed: true,
        ...
        insertRepository: function (data, callback) {
            $http.post('/Admin/CrawlerData/InsertRepository', data).then(callback);
        },
        updateRepository: function (data, callback) {
            $http.post('/Admin/CrawlerData/UpdateRepository', data).then(callback);
        },
        deleteRepository: function (data, callback) {
            $http.post('/Admin/CrawlerData/DeleteRepository?respos=' + data).then(callback);
        },

        //file
        deleteFile: function (data, callback) {
            $http.post('/Admin/CrawlerData/DeleteFile', data).then(callback);
        },
        getContract: function (callback) {
            $http.post('/Admin/CrawlerData/GetContract').then(callback);
        },
        getFileImage: function (data, callback) {
            $http.get('/Admin/CrawlerData/GetFileImage?id=' + data, {
                beforeSend: function () {
                    App.blockUI({
                        target: "#contentMain",
                        boxed: true,
        ...
        getObjectsType: function (callback) {
            $http.post('/Admin/CrawlerData/GetObjectsType').then(callback);
        },
        getListObject: function (data, callback) {
            $http.get('/Admin/CrawlerData/GetListObject?objectType=' + data).then(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/CrawlerData/GetItem?id=' + data).then(callback);
        },
        getItemFile: function (data, data1, data2, callback) {
            $http.get('/Admin/CrawlerData/GetItemFile?id=' + data + '&&IsEdit=' + data1 + '&mode=' + data2).then(callback);
        },

        jtableFileWithRepository: function (data, callback) {
            $http.post('/Admin/CrawlerData/JtableFileWithRepository', data).then(callback);
        },
        getUsers: function (callback) {
            $http.post('/Admin/CrawlerData/GetUsers').then(callback);
        },
        createTempFile: function (data, data1, data2, callback) {
            $http.post('/Admin/CrawlerData/CreateTempFile?Id=' + data + "&isSearch=" + data1 + "&content=" + data2).then(callback);
        },
        getSupportCategory: function (data, callback) {
            $http.post('/Admin/CrawlerData/GetSupportCategory?CatCode=' + data).then(callback);
        },
        getTotal: function (callback) {
            $http.get('/Admin/CrawlerData/GetTotal').then(callback);
        },

        //File && Meta Data
        getTreeCategory: function (callback) {
            $http.post('/Admin/CrawlerData/GetTreeCategory').then(callback);
        },
        insertFile: function (data, callback) {
            submitFormUpload('/Admin/CrawlerData/InsertFile', data, callback);
        },
        dropFile: function (data, /*file,*/ callback) {
            submitFormUploadNew('/Admin/CrawlerData/DropFile', data, /*file,*/ callback);
        },
        getListMetaType: function (callback) {
            $http.post('/Admin/CrawlerData/GetListMetaType').then(callback);
        },
        getListMetaGroup: function (callback) {
            $http.post('/Admin/CrawlerData/GetListMetaGroup').then(callback);
        },
        updateMetaData: function (data1, data2, callback) {
            $http.post('/Admin/CrawlerData/UpdateMetaData?fileId=' + data1 + '&metaDataExt=' + data2).then(callback);
        },
        getMetaData: function (data1, callback) {
            $http.post('/Admin/CrawlerData/GetMetaData?fileId=' + data1).then(callback);
        },

        //OrderDocument & Pack
        getListRack: function (callback) {
            $http.post('/Admin/CrawlerData/GetListRack').then(callback);
        },
        getListPack: function (data, callback) {
            $http.post('/Admin/CrawlerData/GetListPack?rackCode=' + data).then(callback);
        },
        insertPack: function (data, callback) {
            $http.post('/Admin/CrawlerData/InsertPack', data).then(callback);
        },
        getItemPack: function (data, callback) {
            $http.post('/Admin/CrawlerData/GetItemPack?id=' + data).then(callback);
        },
        updatePack: function (data, callback) {
            $http.post('/Admin/CrawlerData/UpdatePack', data).then(callback);
        },
        deletePack: function (data, callback) {
            $http.post('/Admin/CrawlerData/DeletePack?id=' + data).then(callback);
        },

        //paste File
        pasteFile: function (data, callback) {
            $http.post('/Admin/CrawlerData/PasteFile', data).then(callback);
        },

        //ShareFile
        getListUser: function (callback) {
            $http.post('/Admin/CrawlerData/GetListUser').then(callback);
        },
        insertFileShare: function (data, callback) {
            $http.post('/Admin/CrawlerData/InsertFileShare', data).then(callback);
        },
        getFileShare: function (data, callback) {
            $http.post('/Admin/CrawlerData/GetFileShare?id=' + data).then(callback);
        },
...
app.config(function ($routeProvider, $validatorProvider, $httpProvider, $translateProvider) {
    $translateProvider.useUrlLoader('/Admin/CrawlerData/Translation');
    caption = $translateProvider.translations();
    $routeProvider
        .when('/', {
            templateUrl: /*ctxfolderLmsDashBoard + '/index.html'*/ ctxfolderRepository + '/index.html',
...
app.controller('indexCourseware', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRepository, $filter, $window, Upload) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/CrawlerData/JTableFile",
    ...
    $scope.downloadSearch = function (id) {
        ...
        location.href = "/Admin/CrawlerData/DownloadSearch?"
    ...
    $scope.download = function (id) {
        ...
        location.href = "/Admin/CrawlerData/Download?"
            + "Id=" + id;
    }
        ...
        for (var i = 0; i < files.length; i++) {
            ...
            if (listNoteSelect.length == 0) {
                ...
                if ((file.size / 1048576) < 1000) {
                    ...
                    data.IsMore = /*$scope.model.IsScan*/ false;
                    ...
                    Upload.upload({
                        url: '/Admin/CrawlerData/DropFile',
                        data: data
...
app.controller('fileManage', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRepository, $filter, $translate) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/CrawlerData/JtableFileWithRepository",
            beforeSend: function (jqXHR, settings) {
                resetCheckbox();
                App.blockUI({
                    target: "#contentMain",
...
app.controller('tabFileHistory', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRepository, $filter, para) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/CrawlerData/JTableFileHistory",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
    ...
    $scope.viewImage = function (id) {
        ...
        //toDataUrl(window.location.origin + userModel.Url, function (myBase64) {
        //    var modalInstance = $uibModal.open({
        //        templateUrl: '/views/admin/CrawlerData/imageViewer.html',
    ...
    $scope.dowload = function (fileCode) {
        location.href = "/Admin/CrawlerData/DownloadFile?fileCode="
            + fileCode;
    }
...
app.controller('addCategory', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, $uibModalInstance, dataserviceRepository, $filter, $translate) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/CrawlerData/JtableFolderWithRepository",
            beforeSend: function (jqXHR, settings) {
                resetCheckbox();
                App.blockUI({
                    target: "#modal-body",
...
app.controller('addFile', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, $uibModalInstance, dataserviceRepository, para) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/CrawlerData/JtableFolderSettingWithCategory",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
