var ctxfolder = "/views/admin/quoraSocialConfig";
...
app.config(function ($routeProvider, $validatorProvider, $translateProvider, $qProvider) {
    $translateProvider.useUrlLoader('/Admin/QuoraSocialConfig/Translation');
...
{ 'id': 'Hang Bui', 'label': 'Hang Bui' }
    ...
    $scope.ConditionStatement = {
        ...
        Post:
        {
            ...
            Comment_post:
            {
                spaces: $scope.selectedgroup_comment,
                post: ["https://qr.ae/pvse0A","https://qr.ae/pvseLi"],
                content: {
                    Image: "Pictures/Screenshot_1.png",
                    video: "",
                    content: ""
    ...
    dataservice.getbotsocial(9,function (rs) {
        rs = rs.data;
        $scope.listbot = rs;
    });
    $scope.initData();
