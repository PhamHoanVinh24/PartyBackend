var ctxfolder = "/views/admin/EDMSWarehouseManagerAsset";
var ctxfolderMessage = "/views/message-box";
var ctxfolderQrCode = "/views/admin/edmsQRCodeManager";
var app = angular.module('App_ESEIM', ['App_ESEIM_DASHBOARD',"ui.bootstrap", "ngRoute", "ngValidate", "datatables", "datatables.bootstrap", 'datatables.colvis', "ui.bootstrap.contextMenu", 'datatables.colreorder', 'angular-confirm', "ngJsTree", "treeGrid", "ui.select", "ngCookies", "pascalprecht.translate", 'dynamicNumber', 'ngTagsInput', 'monospaced.qrcode']);
...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        getListWareHouse: function (data, callback) {
            $http.get('/Admin/EDMSWarehouseManagerAsset/GetListWareHouse?type=' + data, callback).then(callback);
        },
        getListFloor: function (callback) {
            $http.get('/Admin/EDMSWarehouseManagerAsset/GetListFloor', callback).then(callback);
        },
        getListLine: function (callback) {
            $http.get('/Admin/EDMSWarehouseManagerAsset/GetListLine', callback).then(callback);
        },

        //Chi tiết 1 kho
        getDetailWareHouse: function (data, callback) {
            $http.get('/Admin/EDMSWarehouseManagerAsset/GetDetailWareHouse?wareHouseCode=' + data).then(callback);
        },

        //Danh sách người quản lý
        getListManager: function (callback) {
            $http.get('/Admin/EDMSWarehouseManagerAsset/GetListManager', callback).then(callback);
        },
        //List danh sách nhân viên (người quản lý)
        getListStaffBranch: function (callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/GetListStaffBranch/', callback).then(callback);
        },
        //Sinh mã tầng tự động
        genFloorCode: function (wareHouseCode, floorName, callback) {
            $http.get('/Admin/EDMSWarehouseManagerAsset/GenFloorCode?wareHouseCode=' + wareHouseCode + '&floorName=' + floorName, callback).then(callback);
        },
        genLineCode: function (floorCode, lineName, callback) {
            $http.get('/Admin/EDMSWarehouseManagerAsset/GenLineCode?floorCode=' + floorCode + '&lineName=' + lineName, callback).then(callback);
        },
        genRackCode: function (lineCode, rackName, callback) {
            $http.get('/Admin/EDMSWarehouseManagerAsset/GenRackCode?lineCode=' + lineCode + '&rackName=' + rackName, callback).then(callback);
        },

        //Sinh mã QR_CODE
        generatorQRCode: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/GenQRCode?code=' + data, callback).then(callback);
        },

        //Thêm sửa xóa tầng
        insertFloor: function (data, callback) {
            submitFormUpload('/Admin/EDMSWarehouseManagerAsset/InsertFloor', data, callback);
        },
        getFloorInfo: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/GetFloorInfo?floorId=' + data).then(callback);
        },
        updateFloor: function (data, callback) {
            submitFormUpload('/Admin/EDMSWarehouseManagerAsset/UpdateFloor', data, callback);
        },
        deleteFloor: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/DeleteFloor?floorId=' + data).then(callback);
        },

        //Thêm sửa xóa dãy
        insertLine: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/InsertLine', data, callback).then(callback);
        },
        getLineInfo: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/GetLineInfo?lineId=' + data).then(callback);
        },
        updateLine: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/UpdateLine', data).then(callback);
        },
        deleteLine: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/DeleteLine?lineId=' + data).then(callback);
        },

        //Thêm sửa xóa kệ
        insertRack: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/InsertRack', data, callback).then(callback);
        },
        getRackInfo: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/GetRackInfo?rackId=' + data).then(callback);
        },
        updateRack: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/UpdateRack', data).then(callback);
        },
        deleteRack: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/DeleteRack?rackId=' + data).then(callback);
        },

        //Thêm sửa xóa thùng
        insertBox: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/InsertBox', data, callback).then(callback);
        },
        updateBox: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/UpdateBox', data).then(callback);
        },
        deleteItemBoxs: function (data, callback) {
            $http.post('/Admin/EDMSWarehouseManagerAsset/DeleteItemBoxs', data).then(callback);
        },
    }
});
...
app.config(function ($routeProvider, $validatorProvider, $httpProvider, $translateProvider) {
    $translateProvider.useUrlLoader('/Admin/EDMSWarehouseManagerAsset/Translation');
        ...
        if (floorId != null) {
            var modalInstance = $uibModal.open({
                ...
                controller: function ($scope, $uibModalInstance) {
                    $scope.message = caption.EDMSWH_MSG_CLEAR_FLOORS;
                    $scope.ok = function () {
...
app.controller('listWarehouse', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $translate, $location) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/EDMSWarehouseManagerAsset/JTable",
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('action').notSortable().withOption('sClass', 'dataTable-w80').withTitle($translate('EDMSWM_COL_ACTION')).renderWith(function (data, type, full) {
        return '<button title="{{&quot; EDMSWH_TITLE_REPAIR &quot; | translate}}" ng-click="edit(' + full.Id + ')" style = "width: 25px; height: 25px; padding: 0px;-webkit-box-shadow: 0 2px 5px 0 rgba(85,168,253,0.45);" class="btn btn-icon-only btn-circle btn-outline blue"><i class="fa fa-check"></i></button>' +
            '<button title="{{&quot; EDMSWH_TITLE_DEL &quot; | translate}}" ng-click="delete(' + full.Id + ')" style="width: 25px; height: 25px; padding: 0px;-webkit-box-shadow: 0 2px 5px 0 rgba(230,60,95,0.45)" class="btn btn-icon-only btn-circle btn-outline red hidden"><i class="fa fa-trash"></i></button>';
    }));
...
app.controller('listFloor', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $translate, $location) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/EDMSWarehouseManagerAsset/JTableFloor",
            beforeSend: function (jqXHR, settings) {
                resetCheckbox();
                App.blockUI({
                    target: "#contentMain",
...
app.controller('listLine', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $location, $translate) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/EDMSWarehouseManagerAsset/JTableLine",
            beforeSend: function (jqXHR, settings) {
                resetCheckbox();
                App.blockUI({
                    target: "#contentMain",
...
app.controller('listRack', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $location, $translate) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/EDMSWarehouseManagerAsset/JTableRack",
            beforeSend: function (jqXHR, settings) {
                resetCheckbox();
                App.blockUI({
                    target: "#contentMain",
