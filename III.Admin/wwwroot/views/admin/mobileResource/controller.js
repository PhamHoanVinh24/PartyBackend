var ctxfolder = "/views/admin/mobileResource";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        insert: function (data, callback) {
            $http.post('/Admin/MobileResource/Insert', data).then(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/MobileResource/Update', data).then(callback);
        },
        deleteItems: function (data, callback) {
            $http.post('/Admin/MobileResource/DeleteItems', data).then(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/MobileResource/delete', data).then(callback);
        },
        gitem: function (data, callback) {
            $http.post('/Admin/MobileResource/Getitem', data).then(callback);
        },
        //getall: function (data, callback) {
        //    $http.post('/Admin/MobileResource/getall', data).then(callback);
        //},
        getByName: function (data, callback) {
            $http.get('/Admin/MobileResource/GetByNameAddParent/?name=' + data).then(callback);
        },
        resort: function (data, callback) {
            $http.post('/Admin/MobileResource/Resort', data).then(callback);
        },
        gettreedata: function (data, callback) {
            $http.post('/Admin/MobileResource/Gettreedata', data).then(callback);
        },
        getbyparent: function (data, callback) {
            $http.post('/Admin/MobileResource/Getbyparent/', data).then(callback);
        },
        getGroupResource: function (callback) {
            $http.get('/Admin/MobileResource/GetGroupResource').then(callback);
        },
        insertResAttribute: function (data, callback) {
            $http.post('/Admin/MobileResource/InsertResAttribute', data).then(callback);
        },
        updateResAttribute: function (data, callback) {
            $http.post('/Admin/MobileResource/UpdateResAttribute', data).then(callback);
        },
        deleteResAttribute: function (data, callback) {
            $http.post('/Admin/MobileResource/DeleteResAttribute', data).then(callback);
        },
        getResAttribute: function (data, callback) {
            $http.post('/Admin/MobileResource/GetResAttribute', data).then(callback);
        },
        getTreeFunction: function (data, callback) {
            $http.post('/Admin/MobileResource/GetTreeFunction', data).then(callback);
        },
        //getTreeFunctionData: function (data, callback) {
        //    $http.post('/Admin/MobileResource/GetTreeFunctionData', data).then(callback);
        //},
        addPrivilege: function (data, callback) {
            $http.post('/Admin/MobileResource/AddPrivilege', data).then(callback);
        },
        deletePrivilege: function (data, callback) {
            $http.post('/Admin/MobileResource/DeletePrivilege/', data).then(callback);
        },
        GetFunctionItem: function (callback) {
            $http.post('/Admin/MobileResource/GetTreeFunctionData').then(callback);
        }
    }
});
...
app.config(function ($routeProvider, $validatorProvider, $translateProvider) {
    $translateProvider.useUrlLoader('/Admin/MobileResource/Translation');
...
app.controller('index', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/MobileResource/Jtable",
...
app.controller('function', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $uibModalInstance, para, $timeout) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/MobileResource/JTableFunctionByResourceId",
            beforeSend: function (jqXHR, settings) {
                resetCheckbox();
                App.blockUI({
                    target: "#contentMain",
