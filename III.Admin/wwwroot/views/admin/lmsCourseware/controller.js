...
var ctxfolderCourseware = "/views/admin/lmsCourseware";
...
app.factory('dataserviceRepository', function ($http, /*$upload*/) {
    ...
    return {
        ...
        getTreeInNode: function (data, callback) {
            $http.post('/Admin/LmsCourseware/GetTreeInNode?parentId=' + data).then(callback);
        },
        getParentCategory: function (data, callback) {
            $http.post('/Admin/LmsCourseware/GetParentCategory', data).then(callback);
        },
        getItemCategory: function (data, callback) {
            $http.get('/Admin/LmsCourseware/GetItemCategory?id=' + data).then(callback);
        },
        insertCategory: function (data, callback) {
            $http.post('/Admin/LmsCourseware/InsertCategory', data).then(callback);
        },
        updateCategory: function (data, callback) {
            $http.post('/Admin/LmsCourseware/UpdateCategory', data).then(callback);
        },
        deleteCategory: function (data, callback) {
            $http.post('/Admin/LmsCourseware/DeleteCategory?catCode=' + data).then(callback);
        },

        //repository
        getTreeRepository: function (callback) {
            $http.post('/Admin/LmsCourseware/GetTreeRepository').then(callback);
        },
        getGoogleApiTokens: function (callback) {
            $http.post('/Admin/LmsCourseware/GetGoogleApiTokens').then(callback);
        },
        getItemRepository: function (data, callback) {
            $http.get('/Admin/LmsCourseware/GetItemRepository?reposCode=' + data, {
                beforeSend: function () {
                    App.blockUI({
                        target: "#contentMain",
                        boxed: true,
        ...
        insertRepository: function (data, callback) {
            $http.post('/Admin/LmsCourseware/InsertRepository', data).then(callback);
        },
        updateRepository: function (data, callback) {
            $http.post('/Admin/LmsCourseware/UpdateRepository', data).then(callback);
        },
        deleteRepository: function (data, callback) {
            $http.post('/Admin/LmsCourseware/DeleteRepository?respos=' + data).then(callback);
        },

        //file
        deleteFile: function (data, callback) {
            $http.post('/Admin/LmsCourseware/DeleteFile', data).then(callback);
        },
        getContract: function (callback) {
            $http.post('/Admin/LmsCourseware/GetContract').then(callback);
        },
        getFileImage: function (data, callback) {
            $http.get('/Admin/LmsCourseware/GetFileImage?id=' + data, {
                beforeSend: function () {
                    App.blockUI({
                        target: "#contentMain",
                        boxed: true,
        ...
        getObjectsType: function (callback) {
            $http.post('/Admin/LmsCourseware/GetObjectsType').then(callback);
        },
        getListObject: function (data, callback) {
            $http.get('/Admin/LmsCourseware/GetListObject?objectType=' + data).then(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/LmsCourseware/GetItem?id=' + data).then(callback);
        },
        getItemFile: function (data, data1, data2, callback) {
            $http.get('/Admin/LmsCourseware/GetItemFile?id=' + data + '&&IsEdit=' + data1 + '&mode=' + data2).then(callback);
        },

        jtableFileWithRepository: function (data, callback) {
            $http.post('/Admin/LmsCourseware/JtableFileWithRepository', data).then(callback);
        },
        getUsers: function (callback) {
            $http.post('/Admin/LmsCourseware/GetUsers').then(callback);
        },
        createTempFile: function (data, data1, data2, callback) {
            $http.post('/Admin/LmsCourseware/CreateTempFile?Id=' + data + "&isSearch=" + data1 + "&content=" + data2).then(callback);
        },
        getSupportCategory: function (data, callback) {
            $http.post('/Admin/LmsCourseware/GetSupportCategory?CatCode=' + data).then(callback);
        },
        getTotal: function (callback) {
            $http.get('/Admin/LmsCourseware/GetTotal').then(callback);
        },
        ...
        insertFile: function (data, callback) {
            submitFormUpload('/Admin/LmsCourseware/InsertFile', data, callback);
        },
        dropFile: function (data, /*file,*/ callback) {
            submitFormUploadNew('/Admin/LmsCourseware/DropFile', data, /*file,*/ callback);
        },
        getListMetaType: function (callback) {
            $http.post('/Admin/LmsCourseware/GetListMetaType').then(callback);
        },
        getListMetaGroup: function (callback) {
            $http.post('/Admin/LmsCourseware/GetListMetaGroup').then(callback);
        },
        updateMetaData: function (data1, data2, callback) {
            $http.post('/Admin/LmsCourseware/UpdateMetaData?fileId=' + data1 + '&metaDataExt=' + data2).then(callback);
        },
        getMetaData: function (data1, callback) {
            $http.post('/Admin/LmsCourseware/GetMetaData?fileId=' + data1).then(callback);
        },

        //OrderDocument & Pack
        getListRack: function (callback) {
            $http.post('/Admin/LmsCourseware/GetListRack').then(callback);
        },
        getListPack: function (data, callback) {
            $http.post('/Admin/LmsCourseware/GetListPack?rackCode=' + data).then(callback);
        },
        insertPack: function (data, callback) {
            $http.post('/Admin/LmsCourseware/InsertPack', data).then(callback);
        },
        getItemPack: function (data, callback) {
            $http.post('/Admin/LmsCourseware/GetItemPack?id=' + data).then(callback);
        },
        updatePack: function (data, callback) {
            $http.post('/Admin/LmsCourseware/UpdatePack', data).then(callback);
        },
        deletePack: function (data, callback) {
            $http.post('/Admin/LmsCourseware/DeletePack?id=' + data).then(callback);
        },

        //paste File
        pasteFile: function (data, callback) {
            $http.post('/Admin/LmsCourseware/PasteFile', data).then(callback);
        },

        //ShareFile
        getListUser: function (callback) {
            $http.post('/Admin/LmsCourseware/GetListUser').then(callback);
        },
        insertFileShare: function (data, callback) {
            $http.post('/Admin/LmsCourseware/InsertFileShare', data).then(callback);
        },
        getFileShare: function (data, callback) {
            $http.post('/Admin/LmsCourseware/GetFileShare?id=' + data).then(callback);
        },
...
app.controller('indexCourseware', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRepository, $filter, $window, Upload) {
    ...
    function trackDiligence(taskCode, quizType, objCode, endTime) {
        ...
        dataserviceRepository.trackDilligence(modelDiligence, function (rs) {
            rs = rs.data;
