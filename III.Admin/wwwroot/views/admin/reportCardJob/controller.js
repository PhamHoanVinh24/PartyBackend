var ctxfolder = "/views/admin/reportCardJob";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        getGroupDataLogger: function (callback) {
            $http.post('/Admin/ReportCardJob/GetGroupDataLogger').then(callback);
        },
        getListUser: function (callback) {
            $http.post('/Admin/ReportCardJob/GetListUser').then(callback);
        },
        getListCard: function (callback) {
            $http.post('/Admin/ReportCardJob/GetListCard').then(callback);
        },
        reportCardJob: function (data, callback) {
            $http.post('/Admin/ReportCardJob/ReportCardJob', data).then(callback);
        },
        exportExcel: function (data, callback) {
            $http.post('/Admin/ReportCardJob/ExportExcel', data).then(callback);
        },
    };
});
...
app.config(function ($routeProvider, $validatorProvider, $translateProvider) {
    $translateProvider.useUrlLoader('/Admin/ReportCardJob/Translation');
...
app.controller('index', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter) {
    ...
    $scope.sum = function (isSum) {
        ...
        if (isSum === true) {
            ...
            dataservice.reportCardJob($scope.model, function (rs) {
                rs = rs.data;
    ...
    $scope.export = function () {
        if ($scope.model.Type === '') {
            return App.toastrError(caption.RPTCJ_MSG_PLS_SEARCH);
        }
