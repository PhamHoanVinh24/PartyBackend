var ctxfolderFacebookSocial = "/views/admin/facebookSocial";
var ctxfolderLmsDashBoard = "/views/admin/lmsDashBoard";
var ctxfolderFacebookSocialMessage = "/views/message-box";
...
app.config(function ($routeProvider, $validatorProvider, $translateProvider, $qProvider) {
    ...
    $routeProvider
        .when('/', {
            templateUrl: /*ctxfolderLmsDashBoard + '/index.html'*/ctxfolderFacebookSocial + '/index-course.html',
            controller: 'index'
        })
...
app.controller('index', function ($scope, $rootScope, $sce, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter, $translate) {
    //$scope.index = ctxfolderFacebookSocial + "/index-course.html";
...
app.controller('tablog', function ($scope, $rootScope, $sce, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter, $translate) {
    ...
    vm.dtColumn.push(DTColumnBuilder.newColumn('Id').withTitle('{{"BOT_RUNNING_ORDER" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    ...
    vm.dtColumn.push(DTColumnBuilder.newColumn('Status').withTitle('{{"BOT_RUNNING_FILE_RESULT_DATA" | translate}}').renderWith(function (data, type) {
        return data
    }));
