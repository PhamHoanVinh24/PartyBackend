var ctxfolder = "/views/admin/zoneManager";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        getZoneLevel: function (callback) {
            $http.post('/Admin/ZoneManager/GetZoneLevel').then(callback);
        },
        getZoneGroup: function (callback) {
            $http.post('/Admin/ZoneManager/GetZoneGroup').then(callback);
        },
        getZoneType: function (callback) {
            $http.post('/Admin/ZoneManager/GetZoneType').then(callback);
        },
        getAttrUnit: function (callback) {
            $http.post('/Admin/ZoneManager/GetAttrUnit').then(callback);
        },
        getAttrDataType: function (callback) {
            $http.post('/Admin/ZoneManager/GetAttrDataType').then(callback);
        },
        //Combobox

        insertAttribute: function (data, callback) {
            $http.post('/Admin/ZoneManager/InsertAttribute', data).then(callback);
        },
        updateAttribute: function (data, callback) {
            $http.post('/Admin/ZoneManager/UpdateAttribute', data).then(callback);
        },
        deleteAttribute: function (data, callback) {
            $http.post('/Admin/ZoneManager/DeleteAttribute/' + data).then(callback);
        },
        getDetailAttribute: function (data, callback) {
            $http.post('/Admin/ZoneManager/GetDetailAttribute?Id=' + data).then(callback);
        },

        //Header
        getTreeData: function (data, data1, data2, callback) {
            $http.post('/Admin/ZoneManager/GetTreeData?zoneType=' + data + '&zoneCode=' + data1 + '&zoneLevel=' + data2).then(callback);
        },
        insert: function (data, callback) {
            submitFormUpload('/Admin/ZoneManager/Insert', data, callback);
        },
        update: function (data, callback) {
            submitFormUpload('/Admin/ZoneManager/Update', data, callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/ZoneManager/Delete/' + data).then(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/ZoneManager/GetItem?Id=' + data).then(callback);
        },
    ...
    $scope.col_defs = [
        {
            ...
            sortable: true,
            sortingType: "string",
            displayName: caption.SVC_CURD_TAB_AREA_LABEL,
            cellTemplate: "<i class=''>{{row.branch[col.field]}}</i>"
        },
        {
            field: "Quantity",
            displayName: caption.SVC_CURD_TAB_CAPACITY,
            sortable: true,
            sortingType: "string",
        ...
        },
        {
            ...
            sortable: true,
            sortingType: "int",
            displayName: caption.SVC_CURD_TAB_STT,
        ...
        },
        {
            ...
            sortable: true,
            sortingType: "int",
            displayName: caption.SVC_CURD_TAB_MANU,
            cellTemplate: "<a ng-click='cellTemplateScope.edit(row.branch[col.field])' class= 'fs25 pr10' > <i class='fa-solid fa-pen-to-square' style='--fa-primary-color: green;'></i></a> <a ng-click='cellTemplateScope.delete(row.branch[col.field])' class='fs25'><i class='fa-solid fa-trash'style='--fa-primary-color: red;'></i></a>",
            cellTemplateScope: {
                edit: function (id) {
                    $scope.edit(id);
                },
...
app.controller('add', function ($scope, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, DTInstances, $uibModal, $confirm, $uibModalInstance, dataservice) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ZoneAttrCode').withTitle('{{"SVC_CURD_LBL_CODE_ATTR_AND_NAME" | translate}}').renderWith(function (data, type, full) {
    ...
    //    return data;
    //}));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ZoneAttrValue').withTitle('{{"SVC_CURD_LBL_VALUE_UNIT" | translate}}').renderWith(function (data, type, full) {
...
app.controller('add-attr', function ($scope, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, DTInstances, $uibModal, $confirm, $uibModalInstance, dataservice) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/ZoneManager/JtableAttribute",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('action').notSortable().withOption('sClass', 'w75').withTitle('{{"COM_LIST_COL_ACTION" | translate}}').renderWith(function (data, type, full) {
        return '<a ng-click="edit(' + full.Id + ')" /*style = "width: 25px; height: 25px; padding: 0px"*/ class="fs25 pr10"><i class="fas fa-edit" style="--fa-primary-color: green;"></i></a>' +
            '<a title="Xoá" ng-click="delete(' + full.Id + ')" /*style="width: 25px; height: 25px; padding: 0px"*/ class="fs25"><i class="fas fa-trash" style="--fa-primary-color: red;"></i></a>';
    }));
    vm.reloadData = reloadData;
    vm.dtInstance = {};
    function reloadData(resetPaging) {
