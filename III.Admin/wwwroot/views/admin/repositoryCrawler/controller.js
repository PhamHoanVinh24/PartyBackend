...
var ctxfolderCourseware = "/views/admin/repositoryCrawler";
...
app.factory('dataserviceRepository', function ($http, /*$upload*/) {
    ...
    return {
        ...
        getTreeInNode: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/GetTreeInNode?parentId=' + data).then(callback);
        },
        getParentCategory: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/GetParentCategory', data).then(callback);
        },
        getItemCategory: function (data, callback) {
            $http.get('/Admin/RepositoryCrawler/GetItemCategory?id=' + data).then(callback);
        },
        insertCategory: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/InsertCategory', data).then(callback);
        },
        updateCategory: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/UpdateCategory', data).then(callback);
        },
        deleteCategory: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/DeleteCategory?catCode=' + data).then(callback);
        },

        //repository
        getTreeRepository: function (callback) {
            $http.post('/Admin/RepositoryCrawler/GetTreeRepository').then(callback);
        },
        getGoogleApiTokens: function (callback) {
            $http.post('/Admin/RepositoryCrawler/GetGoogleApiTokens').then(callback);
        },
        getItemRepository: function (data, callback) {
            $http.get('/Admin/RepositoryCrawler/GetItemRepository?reposCode=' + data, {
                beforeSend: function () {
                    App.blockUI({
                        target: "#contentMain",
                        boxed: true,
        ...
        insertRepository: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/InsertRepository', data).then(callback);
        },
        updateRepository: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/UpdateRepository', data).then(callback);
        },
        deleteRepository: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/DeleteRepository?respos=' + data).then(callback);
        },

        //file
        deleteFile: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/DeleteFile', data).then(callback);
        },
        getContract: function (callback) {
            $http.post('/Admin/RepositoryCrawler/GetContract').then(callback);
        },
        getFileImage: function (data, callback) {
            $http.get('/Admin/RepositoryCrawler/GetFileImage?id=' + data, {
                beforeSend: function () {
                    App.blockUI({
                        target: "#contentMain",
                        boxed: true,
        ...
        getObjectsType: function (callback) {
            $http.post('/Admin/RepositoryCrawler/GetObjectsType').then(callback);
        },
        getListObject: function (data, callback) {
            $http.get('/Admin/RepositoryCrawler/GetListObject?objectType=' + data).then(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/GetItem?id=' + data).then(callback);
        },
        getItemFile: function (data, data1, data2, callback) {
            $http.get('/Admin/RepositoryCrawler/GetItemFile?id=' + data + '&&IsEdit=' + data1 + '&mode=' + data2).then(callback);
        },

        jtableFileWithRepository: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/JtableFileWithRepository', data).then(callback);
        },
        getUsers: function (callback) {
            $http.post('/Admin/RepositoryCrawler/GetUsers').then(callback);
        },
        createTempFile: function (data, data1, data2, callback) {
            $http.post('/Admin/RepositoryCrawler/CreateTempFile?Id=' + data + "&isSearch=" + data1 + "&content=" + data2).then(callback);
        },
        getSupportCategory: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/GetSupportCategory?CatCode=' + data).then(callback);
        },
        getTotal: function (callback) {
            $http.get('/Admin/RepositoryCrawler/GetTotal').then(callback);
        },

        //File && Meta Data
        getTreeCategory: function (callback) {
            $http.post('/Admin/RepositoryCrawler/GetTreeCategory').then(callback);
        },
        insertFile: function (data, callback) {
            submitFormUpload('/Admin/RepositoryCrawler/InsertFile', data, callback);
        },
        dropFile: function (data, /*file,*/ callback) {
            submitFormUploadNew('/Admin/RepositoryCrawler/DropFile', data, /*file,*/ callback);
        },
        getListMetaType: function (callback) {
            $http.post('/Admin/RepositoryCrawler/GetListMetaType').then(callback);
        },
        getListMetaGroup: function (callback) {
            $http.post('/Admin/RepositoryCrawler/GetListMetaGroup').then(callback);
        },
        updateMetaData: function (data1, data2, callback) {
            $http.post('/Admin/RepositoryCrawler/UpdateMetaData?fileId=' + data1 + '&metaDataExt=' + data2).then(callback);
        },
        getMetaData: function (data1, callback) {
            $http.post('/Admin/RepositoryCrawler/GetMetaData?fileId=' + data1).then(callback);
        },

        //OrderDocument & Pack
        getListRack: function (callback) {
            $http.post('/Admin/RepositoryCrawler/GetListRack').then(callback);
        },
        getListPack: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/GetListPack?rackCode=' + data).then(callback);
        },
        insertPack: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/InsertPack', data).then(callback);
        },
        getItemPack: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/GetItemPack?id=' + data).then(callback);
        },
        updatePack: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/UpdatePack', data).then(callback);
        },
        deletePack: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/DeletePack?id=' + data).then(callback);
        },

        //paste File
        pasteFile: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/PasteFile', data).then(callback);
        },

        //ShareFile
        getListUser: function (callback) {
            $http.post('/Admin/RepositoryCrawler/GetListUser').then(callback);
        },
        insertFileShare: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/InsertFileShare', data).then(callback);
        },
        getFileShare: function (data, callback) {
            $http.post('/Admin/RepositoryCrawler/GetFileShare?id=' + data).then(callback);
        },
...
app.controller('Ctrl_ESEIM_REPOSITORY', function ($scope, $rootScope, $filter, $location, $cookies, $translate) {
    ...
    $scope.FileType = [{
        Code: 1,
        Name: caption.LMS_DOCUMENT_MSG_IMAGE,
    }, {
            Code: 2,
            Name: caption.LMS_DOCUMENT_MSG_WORK
    }, {
            Code: 3,
            Name: caption.LMS_DOCUMENT_MSG_EXCEL
    }, {
            Code: 4,
            Name: caption.LMS_DOCUMENT_MSG_POWERPOINT
    }, {
            Code: 5,
            Name: caption.LMS_DOCUMENT_MSG_PDF
    }, {
            Code: 6,
            Name: caption.LMS_DOCUMENT_MSG_FILE
    }];
    $rootScope.RepoType = [{
        Code: "DRIVER",
        Name: caption.LMS_DOCUMENT_MSG_GG_DRIVER,
    }, {
            Code: "SERVER",
            Name: caption.LMS_DOCUMENT_MSG_FPT_SEVER,
    },];
    $rootScope.listUnit = [{
        Code: '1',
        Name: caption.LMS_DOCUMENT_MSG_PRACTICE
    }, {
            Code: '2',
            Name: caption.LMS_DOCUMENT_MSG_EDDY
    }, {
            Code: '3',
            Name: caption.LMS_DOCUMENT_MSG_BIN
    }];
});
app.config(function ($routeProvider, $validatorProvider, $httpProvider, $translateProvider) {
    $translateProvider.useUrlLoader('/Admin/LmsCourseware/Translation');
    caption = $translateProvider.translations();
    $routeProvider
        .when('/', {
            templateUrl: /*ctxfolderLmsDashBoard + '/index.html'*/ ctxfolderCourseware + '/index.html',
            controller: 'indexCourseware'
        })
    //.when('/pdfViewer', {
...
app.controller('indexCourseware', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRepository, $filter, $window, Upload) {
    //$scope.index = ctxfolderRepository + "/index.html";
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/LmsCourseware/JTableFile",
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('FileName').withOption('sClass', 'nowrap').withTitle('{{"EDMSR_LIST_COL_FILE_NAME" |translate}}').renderWith(function (data, type, full) {
        ...
        var hierachyPack = "";
        if (full.PackHierarchy != caption.LMS_DOCUMENT_MSG_NOT_PACKAGE) {
            if (full.FileType == "Y") {
                hierachyPack = '<div class="pt10"><span class="">&bull;{{"LMS_DOCUMENT_LBL_PACKED" | translate}} ' + '<span class="text-green">' + full.PackHierarchy +
                    '</span></span>  <a ng-click="recordPack(\'' + full.FileCode + '\', \'' + full.FileType + '\')" target="_blank" style="width: 25px;height: 25px;padding: 0px;float: right;" title="{{&quot; LMS_DOCUMENT_LBL_PACKED &quot; | translate}} - ' + full.FileName + '" class="btn btn-icon-only btn-circle btn-outline green "><i class="fa fa-cubes pt5"></i></a></div>';
            }
        }
        else {
            if (full.FileType == "Y") {
        ...
        if (full.ZoneHierarchy != "Chưa xếp") {
            if (full.FileType == "Y") {
                hirarchyZone = '<div class="pt10"><span class="">&bull;{{"LMS_DOCUMENT_TXT_LOCATION" | translate}} ' + '<span class="text-green">' + full.ZoneHierarchy +
                    '</span></span>  <a ng-click="arrangeFile(\'' + full.FileCode + '\', \'' + full.FileType + '\', \'' + full.PackHierarchy + '\')" target="_blank" style="width: 25px;height: 25px;padding: 0px;float: right;" title="{{&quot; LMS_DOCUMENT_LBL_REARRANGE &quot; | translate}} - ' + full.FileName + '" class="btn btn-icon-only btn-circle btn-outline green "><i class="fa fa-map-marker pt5"></i></a></div>';
            }
        }
        else {
            if (full.FileType == "Y") {
                hirarchyZone = '<div class="pt10"><span class="">&bull;{{"LMS_DOCUMENT_TXT_LOCATION" | translate}} ' + '<span class="text-danger">' + full.ZoneHierarchy +
                    '</span></span>  <a ng-click="arrangeFile(\'' + full.FileCode + '\', \'' + full.FileType + '\', \'' + full.PackHierarchy + '\')" target="_blank" style="width: 25px;height: 25px;padding: 0px;float: right;" title="{{&quot; LMS_DOCUMENT_LBL_ARRANGE_IN &quot; | translate}} - ' + full.FileName + '" class="btn btn-icon-only btn-circle btn-outline green "><i class="fa fa-map-marker pt5"></i></a></div>';
            }
        }
    ...
    $scope.arrangeFile = function (fileCode, isFileScan, hierachyPack) {
        debugger
        if (isFileScan == "N") {
            return App.toastrError(caption.LMS_DOCUMENT_MSG_FILE_CANNOT_ARRANGE);
        }
        if (hierachyPack == caption.LMS_DOCUMENT_MSG_NOT_PACKAGE) {
    ...
    $scope.downloadSearch = function (id) {
        ...
        location.href = "/Admin/LmsCourseware/DownloadSearch?"
    ...
    $scope.download = function (id) {
        ...
        location.href = "/Admin/LmsCourseware/Download?"
            + "Id=" + id;
    }
        ...
        for (var i = 0; i < files.length; i++) {
            ...
            if (listNoteSelect.length == 0) {
                ...
                if ((file.size / 1048576) < 1000) {
                    ...
                    Upload.upload({
                        url: '/Admin/LmsCourseware/DropFile',
                        data: data
...
app.controller('fileManage', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRepository, $filter, $translate) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/LmsCourseware/JtableFileWithRepository",
            beforeSend: function (jqXHR, settings) {
                resetCheckbox();
                App.blockUI({
                    target: "#contentMain",
...
app.controller('tabFileHistory', function ($scope, $rootScope, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceRepository, $filter, para) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/LmsCourseware/JTableFileHistory",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
    ...
    $scope.viewImage = function (id) {
        ...
        //toDataUrl(window.location.origin + userModel.Url, function (myBase64) {
        //    var modalInstance = $uibModal.open({
        //        templateUrl: '/views/admin/LmsCourseware/imageViewer.html',
    ...
    $scope.dowload = function (fileCode) {
        location.href = "/Admin/LmsCourseware/DownloadFile?fileCode="
            + fileCode;
    }
...
app.controller('addCategory', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, $uibModalInstance, dataserviceRepository, $filter, $translate) {
    ...
    $scope.treeDataRepository = [];
    $scope.listModule = [{
        Code: 'PROJECT', Name: caption.LMS_DOCUMENT_MSG_PROJECT
    }, {
            Code: 'CARD_ASSIGN', Name: caption.LMS_DOCUMENT_MSG_CARDJOB
        }, {
            Code: 'EMPLOYEES', Name: caption.LMS_DOCUMENT_MSG_PERSONNAL
        }, {
            Code: 'PRODUCT', Name: caption.LMS_DOCUMENT_MSG_PRODUCT
        }, {
            Code: 'WORKFLOW', Name: caption.LMS_DOCUMENT_MSG_WORK_FLOW
    },]
    $scope.model = {
        CatCode: '',
        CatName: '',
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/LmsCourseware/JtableFolderWithRepository",
            beforeSend: function (jqXHR, settings) {
                resetCheckbox();
                App.blockUI({
                    target: "#modal-body",
...
app.controller('addFile', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, $uibModalInstance, dataserviceRepository, para) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/LmsCourseware/JtableFolderSettingWithCategory",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
        ...
        var modalInstance = $uibModal.open({
            ...
            resolve: {
                para: function () {
                    return {
                        Group: 'META_GROUP',
                        GroupNote: caption.LMS_DOCUMENT_MSG_SHORT_DESCIPTION_GROUP,
                        AssetCode: ''
                    };
                }
            }
