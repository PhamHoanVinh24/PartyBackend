var ctxfolder = "/views/admin/edmsWareHouseProfileVouchersDocument";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        insert: function (data, callback) {
            submitFormUpload('/Admin/edmsWareHouseProfileVouchersDocument/Insert', data, callback);
        },
        update: function (data, callback) {
            submitFormUpload('/Admin/edmsWareHouseProfileVouchersDocument/Update', data, callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/edmsWareHouseProfileVouchersDocument/Delete/' + data).then(callback);
        },
        getArea: function (callback) {
            $http.post('/Admin/edmsWareHouseProfileVouchersDocument/GetListArea').then(callback);
        },
        ...
        getFile: function (data, callback) {
            $http.post('/Admin/edmsWareHouseProfileVouchersDocument/GetFile/' + data).then(callback);
        },
        insertFile: function (data, callback) {
            submitFormUpload('/Admin/edmsWareHouseProfileVouchersDocument/InsertFile/', data, callback);
        },
        updateFile: function (data, callback) {
            submitFormUpload('/Admin/edmsWareHouseProfileVouchersDocument/UpdateFile/', data, callback);
        },
        deleteFile: function (data, callback) {
            $http.post('/Admin/edmsWareHouseProfileVouchersDocument/DeleteFile/' + data).then(callback);
        },
        getSuggestionsFile: function (data, callback) {
            $http.get('/Admin/edmsWareHouseProfileVouchersDocument/GetSuggestionsFile?whsCode=' + data).then(callback);
        },
        ...
        insertExtend: function (data, callback) {
            $http.post('/Admin/edmsWareHouseProfileVouchersDocument/InsertExtend/', data).then(callback);
        },
        deleteExtend: function (data, callback) {
            $http.post('/Admin/edmsWareHouseProfileVouchersDocument/DeleteExtend/' + data).then(callback);
        },
        updateExtend: function (data, callback) {
            $http.post('/Admin/edmsWareHouseProfileVouchersDocument/UpdateExtend/', data).then(callback);
        },
        getExtend: function (data, callback) {
            $http.get('/Admin/edmsWareHouseProfileVouchersDocument/GetExtend/' + data).then(callback);
        },
    };
});
...
app.config(function ($routeProvider, $validatorProvider, $translateProvider, $httpProvider) {
    $translateProvider.useUrlLoader('/Admin/edmsWareHouseProfileVouchersDocument/Translation');
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter, $window) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/edmsWareHouseProfileVouchersDocument/JTable",
...
app.controller('file', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/edmsWareHouseProfileVouchersDocument/JTableFile",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('action').withTitle('{{"COM_LIST_COL_ACTION" | translate}}').withOption('sClass', 'nowrap').renderWith(function (data, type, full) {
        if (full.TypeFile == "SHARE") {
            ...
            return '<button title="{{&quot; EDMSWHPV_TITLE_REPAIR &quot; | translate}}" ng-click="edit(\'' + full.FileName + '\',' + full.Id + ')"  style = "width: 25px; height: 25px; padding: 0px" class="btn btn-icon-only btn-circle btn-outline blue"><i class="fa fa-edit"></i></button>' +
                '<a ng-click="dowload(' + full.Id + ')" style="width: 25px; height: 25px; padding: 0px" title="{{&quot; EDMSWHPV_TITLE_DOWLOAD &quot; | translate}} - ' + full.FileName + '" class="btn btn-icon-only btn-circle btn-outline green"><i class="fa fa-download pt5"></i></a>' +
    ...
    $scope.dowload = function (id) {
        location.href = "/Admin/edmsWareHouseProfileVouchersDocument/DownloadFile?"
            + "id=" + id;
    }
...
app.controller('more', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter, $translate, $window) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/edmsWareHouseProfileVouchersDocument/JTableExtend",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
