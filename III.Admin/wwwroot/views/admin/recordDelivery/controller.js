var ctxfolder = "/views/admin/recordDelivery";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        insertRecordDeliveryDetail: function (data, callback) {
            $http.post("/Admin/RecordDelivery/InsertRecordDeliveryDetail", data).then(callback);
        },
        ...
        deleteDetail: function (data, callback) {
            $http.post("/Admin/RecordDelivery/DeleteDetail?id=" + data).then(callback);
        },
...
app.controller('index', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $translate, $window) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/RecordDelivery/JTableDetail",
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('RecordName').withTitle('{{"Hồ sơ" | translate}}').renderWith(function (data, type) {
        return data;
    }));
