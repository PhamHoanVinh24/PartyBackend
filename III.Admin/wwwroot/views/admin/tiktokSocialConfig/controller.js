var ctxfolder = "/views/admin/tiktokSocialConfig";
...
{ 'id': 'Hang Bui', 'label': 'Hang Bui' }
    ...
    $scope.ConditionStatement = {
        ...
        Like:
        {
            Post:
            {
                Post: ["https://www.tiktok.com/@caocuongvu/video/7074895619197865243?is_from_webapp=1&sender_device=pc", "https://www.tiktok.com/@hoaa.hanassii?lang=en"]
            },
    ...
    dataservice.getbotsocial(3,function (rs) {
        rs = rs.data;
        $scope.listbot = rs;
    });
    $scope.initData();
