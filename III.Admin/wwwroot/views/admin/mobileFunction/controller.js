var ctxfolder = "/views/admin/mobileFunction";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        //    $http.get('/Admin/MobileFunction/getall').then(callback);
        //},
        //getByName: function (data, callback) {
        //    $http.get('/Admin/MobileFunction/GetByNameAddParent/?name=' + data).then(callback);
        //},
        insert: function (data, callback) {
            $http.post('/Admin/MobileFunction/insert', data).then(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/MobileFunction/update', data).then(callback);
        },
        deleteItems: function (data, callback) {
            $http.post('/Admin/MobileFunction/DeleteItems', data).then(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/MobileFunction/delete', data).then(callback);
        },
        gitem: function (data, callback) {
            $http.post('/Admin/MobileFunction/getitem', data).then(callback);
        },
        resort: function (data, callback) {
            $http.post('/Admin/MobileFunction/resort', data).then(callback);
        },
        gettreedata: function (data, callback) {
            $http.post('/Admin/MobileFunction/gettreedata', data).then(callback);
        },
        getbyparent: function (data, callback) {
            $http.post('/Admin/MobileFunction/getbyparent/', data).then(callback);
        },
        getGroupResource: function (callback) {
            $http.get('/Admin/MobileFunction/getGroupResource').then(callback);
        },
        insertResAtribute: function (data, callback) {
            $http.post('/Admin/MobileFunction/InsertResAtribute', data).then(callback);
        },
        updateResAtribute: function (data, callback) {
            $http.post('/Admin/MobileFunction/UpdateResAtribute', data).then(callback);
        },
        deleteResAtribute: function (data, callback) {
            $http.post('/Admin/MobileFunction/DeleteResAtribute', data).then(callback);
        },
        getResAtribute: function (data, callback) {
            $http.post('/Admin/MobileFunction/GetResAtribute', data).then(callback);
        },
        getResourceByFunctionId: function (data, callback) {
            $http.post('/Admin/MobileFunction/GetResourceByFunctionId/' + data).then(callback);
        },
        getTreeResourceData: function (data, callback) {
            $http.post('/Admin/MobileFunction/GetTreeResourceData/' + data).then(callback);
        },
        addResource: function (data, callback) {
            $http.post('/Admin/MobileFunction/AddResource', data).then(callback);
        },
        deletePrivilege: function (data, callback) {
            $http.post('/Admin/MobileFunction/DeletePrivilege/', data).then(callback);
        },
...
app.config(function ($routeProvider, $validatorProvider, $translateProvider, $httpProvider) {
    ...
    $translateProvider.useUrlLoader('/Admin/MobileFunction/Translation');
...
app.controller('index', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/MobileFunction/jtable",
...
app.controller('resource', function ($scope, $rootScope, $confirm, $compile, $uibModal, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, para, $timeout) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/MobileFunction/JTableResourceByFunctionId",
            beforeSend: function (jqXHR, settings) {
                resetCheckbox();
                App.blockUI({
                    target: "#contentMain",
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn("ResourceCode").withTitle("").notSortable().renderWith(function (data, type, full, meta) {
        return "<div class='fs25' ng-click='removeFuncResource(\"" + data + "\")'><i class='fa-solid fa-trash' style='color: #e34678;'></i></div>";
    }).withOption('sWidth', '30px').withOption('sClass', 'tcenter'));
    vm.reloadData = reloadData;
    vm.dtInstance = {};
    function reloadData(resetPaging) {
