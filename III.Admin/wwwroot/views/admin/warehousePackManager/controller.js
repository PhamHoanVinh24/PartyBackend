var ctxfolder = "/views/admin/warehousePackManager";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        getPackGroup: function (callback) {
            $http.post('/Admin/WarehousePackManager/GetPackGroup').then(callback);
        },
        getPackType: function (callback) {
            $http.post('/Admin/WarehousePackManager/GetPackType').then(callback);
        },
        getUnitPack: function (callback) {
            $http.post('/Admin/WarehousePackManager/GetUnitPack').then(callback);
        },
        getAttrDataType: function (callback) {
            $http.post('/Admin/WarehousePackManager/GetAttrDataType').then(callback);
        },
        getTreeRecordsPack: function (callback) {
            $http.post('/Admin/WarehousePackManager/GetTreeRecordsPack').then(callback);
        },
        ...
        getTreeData: function (callback) {
            $http.post('/Admin/WarehousePackManager/GetTreeData').then(callback);
        },
        ...
        insertPackAttribute: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/InsertPackAttribute', data).then(callback);
        },
        updatePackAttribute: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/UpdatePackAttribute', data).then(callback);
        },
        getItemPackAttr: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/GetItemPackAttr?id=' + data).then(callback);
        },
        deletePackAttribute: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/DeletePackAttribute?id=' + data).then(callback);
        },

        //Records Pack
        insertRecordsPack: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/InsertRecordsPack', data).then(callback);
        },

        //Records Pack Arrange
        getRecordsPack: function (data1, data2, callback) {
            $http.get('/Admin/WarehousePackManager/GetRecordsPack?packType=' + data1 + '&level=' + data2).then(callback);
        },

        //Info additional
        getInfoRecordsPack: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/GetInfoRecordsPack?packCode=' + data).then(callback);
        },

        //Encapsulate
        encapsulateRecordsPack: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/EncapsulateRecordsPack', data).then(callback);
        },
        autoUpdateHierarchy: function (callback) {
            $http.post('/Admin/WarehousePackManager/AutoUpdateHierarchy').then(callback);
        },

        //Arrange
        arrangeRecordsPack: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/ArrangeRecordsPack', data).then(callback);
        },
        checkArrangeRecordPack: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/CheckArrangeRecordPack?packCode=' + data).then(callback);
        },

        //Delete Record Pack
        deleteRecordsPack: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/DeleteRecordsPack?id=' + data).then(callback);
        },

        //Update Records Pack
        getItemRecordsPack: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/GetItemRecordsPack?id=' + data).then(callback);
        },
        updateRecordsPack: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/UpdateRecordsPack', data).then(callback);
        },

        //File Pack Record
        getFileEdms: function (callback) {
            $http.post('/Admin/WarehousePackManager/GetFileEdms').then(callback);
        },
        insertRecordsFilePack: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/InsertRecordsFilePack', data).then(callback);
        },
        deleteRecordFile: function (data, callback) {
            $http.post('/Admin/WarehousePackManager/DeleteRecordFile?id=' + data).then(callback);
        }
    }
});
...
app.controller('Ctrl_ESEIM', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, $confirm, DTColumnBuilder, DTInstances, dataservice, $cookies, $translate) {
    ...
    $rootScope.$on('$translateChangeSuccess', function () {
        ...
        $rootScope.validationOptionsRecordsPack = {
            ...
            messages: {
                PackCode: {
                    required: "Mã đối tượng không được bỏ trống",
...
app.config(function ($routeProvider, $validatorProvider, $translateProvider) {
    $translateProvider.useUrlLoader('/Admin/WarehousePackManager/Translation');
    ...
    $scope.col_defs = [
        {
            ...
            sortable: true,
            sortingType: "string",
            displayName: caption.WPM_LABEL,
            cellTemplate: "<i class=''>{{row.branch[col.field]}}</i>"
        },
        {
            field: "Quantity",
            displayName: caption.WPM_QUANTITY,
            sortable: true,
            sortingType: "string",
        ...
        },
        {
            ...
            sortable: true,
            sortingType: "int",
            displayName: caption.WPM_STATUS,
        ...
        },
        {
            ...
            sortable: true,
            sortingType: "int",
            displayName: caption.WPM_MANIPULATION,
            cellTemplate: "<a ng-click='cellTemplateScope.edit(row.branch[col.field])' style='width: 25px; height: 25px; padding-right: 5px' class= '' > <i style='--fa-primary-color: green;' class='fa-solid fa-pen-to-square fs25'></i></a> <a ng-click='cellTemplateScope.delete(row.branch[col.field])' style='width: 25px; height: 25px; padding: 0px' class=''><i style='--fa-primary-color: red;' class='fa-solid fa-trash fs25'></i></a>",
            cellTemplateScope: {
                edit: function (id) {
                    $scope.editRecord(id);
                },
...
app.controller('recordsAttribute', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, $confirm, $uibModalInstance, dataservice) {
    $scope.model = {
        PackAttrType: "",
        PackAttrGroup: "",
        PackAttrCode: "",
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/WarehousePackManager/JTablePackAttribute",
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('PackAttrCode').withTitle('{{"WPM_CODE_ATTR" | translate}}').renderWith(function (data, type) {
        return data;
    }));

    vm.dtColumns.push(DTColumnBuilder.newColumn('PackAttrName').withTitle('{{"WPM_NAME_ATTR" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('PackAttrSize').withTitle('{{"WPM_STYPE_DATA" | translate}}').renderWith(function (data, type) {
        return data;
    }));

    vm.dtColumns.push(DTColumnBuilder.newColumn('PackAttrType').withTitle('{{"WPM_STYPE_PACK_BTN" | translate}}').renderWith(function (data, type) {
        return data;
    }));

    vm.dtColumns.push(DTColumnBuilder.newColumn('PackAttrGroup').withTitle('{{"WPM_GROUP_PACK" | translate}}').renderWith(function (data, type) {
        return data;
    }));

    vm.dtColumns.push(DTColumnBuilder.newColumn('PackAttrSize').withTitle('{{"WPM_SIZE" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('action').notSortable().withOption('sClass', 'w75').withTitle('{{"COM_LIST_COL_ACTION" | translate}}').renderWith(function (data, type, full) {
        return '<a ng-click="edit(' + full.ID + ')" " class="fs25 pr5"><i style="--fa-primary-color: green;" class="fa-solid fa-pen-to-square"></i></a>' +
            '<a title="Xoá" ng-click="deletePackAttr(' + full.ID + ')"  class="fs25"><i style="--fa-primary-color: red;" class="fa-solid fa-trash"></i></a>';
    }));
...
app.controller('add-pack-records', function ($scope, $rootScope, $confirm, DTOptionsBuilder, $compile, $uibModal, $uibModalInstance, DTColumnBuilder, DTInstances, dataservice, $translate, $window) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/WarehousePackManager/JTableRecordsPack",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
...
app.controller('record-pack-files', function ($scope, $rootScope, $confirm, DTOptionsBuilder, $compile, $uibModal, DTColumnBuilder, DTInstances, dataservice, $translate, $timeout) {
    $scope.model = {
        FileCode: "",
        PackCode: ""
    }
    ...
    $scope.submit = function () {
        ...
        if (!$rootScope.isAdded) {
            return App.toastrError("Vui lòng thêm gói trước");
        }
    ...
    $scope.toggleAll = toggleAll;
    $scope.toggleOne = toggleOne;
    $scope.headerCompiledFile = false;
    var titleHtml = '<label class="mt-checkbox"><input type="checkbox" ng-model="selectAll" ng-change="toggleAll(selectAll, selected)"/><span></span></label>';
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/WarehousePackManager/JTableFileRecordPack",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
        ...
        .withOption('serverSide', true)
        .withOption('headerCallback', function (header) {
            if (!$scope.headerCompiledFile) {
                $scope.headerCompiledFile = true;
                $compile(angular.element(header).contents())($scope);
                $timeout(function () {
                    $scope.$apply();
                });
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('FileName').withTitle('{{"WPM_FILE" | translate}}').renderWith(function (data, type) {
        return data;
    }));

    vm.dtColumns.push(DTColumnBuilder.newColumn('Url').withTitle('{{"WPM_PATH" | translate}}').renderWith(function (data, type) {
        return data;
    }));

    vm.dtColumns.push(DTColumnBuilder.newColumn('action').notSortable().withOption('sClass', 'w75').withTitle('{{"WPM_MANIPULATION" | translate}}').renderWith(function (data, type, full) {
        return '<a title="Xoá" ng-click="deletePackFile(' + full.Id + ')" style="width: 25px; height: 25px; padding: 0px" class=""><i style="--fa-primary-color: red;" class="fa-solid fa-trash  fs25"></i></a>';
    }));
...
app.controller('records-pack-arrange', function ($scope, $rootScope, $confirm, DTOptionsBuilder, $compile, $uibModal, $uibModalInstance, DTColumnBuilder, DTInstances, dataservice, $translate, $window) {
    ...
    $scope.addBellow = function () {
        ...
        if ($scope.model.PackCode == "" || $scope.model.PackCode == null || $scope.model.PackCode == undefined) {
            return App.toastrError("Vui lòng chọn gói cần đóng gói");
        }
        ...
        if (!check) {
            ...
            App.toastrError("Gói cần đóng gói đã được thêm vào danh sách");
        }
    }
    ...
    $scope.arrangePack = function () {
        ...
        if ($scope.lstRecordPackAddedRight.length == 0) {
            return App.toastrError("Vui lòng chọn gói đóng gói");
        }
        var isOnePack = 0;
        for (var i = 0; i < $scope.lstRecordPackAddedRight.length; i++) {
            if ($scope.lstRecordPackAddedRight[i].PackCode != "") {
        ...
        if (isOnePack > 1) {
            return App.toastrError("Vui lòng chọn 1 gói cần đóng gói");
        }
        ...
        dataservice.checkArrangeRecordPack(obj.ListRecordsPack, function (rs) {
            ...
            if (rs) {
                var modalInstance = $uibModal.open({
                    ...
                    windowClass: "message-center",
                    controller: function ($scope, $uibModalInstance, para) {
                        $scope.message = "Gói cần xếp đã được xếp kho, bạn có muốn tách khỏi gói cha để xếp?";
                        $scope.ok = function () {
