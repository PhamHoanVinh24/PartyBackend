var ctxfolder = "/views/admin/warehouseZoneManager";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        getZoneLevel: function (callback) {
            $http.post('/Admin/WarehouseZoneManager/GetZoneLevel').then(callback);
        },
        getZoneGroup: function (callback) {
            $http.post('/Admin/WarehouseZoneManager/GetZoneGroup').then(callback);
        },
        getZoneType: function (callback) {
            $http.post('/Admin/WarehouseZoneManager/GetZoneType').then(callback);
        },
        getAttrUnit: function (callback) {
            $http.post('/Admin/WarehouseZoneManager/GetAttrUnit').then(callback);
        },
        getAttrDataType: function (callback) {
            $http.post('/Admin/WarehouseZoneManager/GetAttrDataType').then(callback);
        },
        //Combobox

        insertAttribute: function (data, callback) {
            $http.post('/Admin/WarehouseZoneManager/InsertAttribute', data).then(callback);
        },
        updateAttribute: function (data, callback) {
            $http.post('/Admin/WarehouseZoneManager/UpdateAttribute', data).then(callback);
        },
        deleteAttribute: function (data, callback) {
            $http.post('/Admin/WarehouseZoneManager/DeleteAttribute/' + data).then(callback);
        },
        getDetailAttribute: function (data, callback) {
            $http.post('/Admin/WarehouseZoneManager/GetDetailAttribute?Id=' + data).then(callback);
        },

        //Header
        getTreeData: function (data, data1, data2, callback) {
            $http.post('/Admin/WarehouseZoneManager/GetTreeData?zoneType=' + data + '&zoneCode=' + data1 + '&zoneLevel=' + data2).then(callback);
        },
        insert: function (data, callback) {
            submitFormUpload('/Admin/WarehouseZoneManager/Insert', data, callback);
        },
        update: function (data, callback) {
            submitFormUpload('/Admin/WarehouseZoneManager/Update', data, callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/WarehouseZoneManager/Delete/' + data).then(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/WarehouseZoneManager/GetItem?Id=' + data).then(callback);
        },
...
app.config(function ($routeProvider, $validatorProvider, $translateProvider) {
    $translateProvider.useUrlLoader('/Admin/WarehouseZoneManager/Translation');
    ...
    $scope.col_defs = [
        {
            ...
            sortable: true,
            sortingType: "string",
            displayName: caption.WZM_AREA_LABEL,
            cellTemplate: "<i class=''>{{row.branch[col.field]}}</i>"
        },
        {
            field: "Quantity",
            displayName: caption.WZM_REGIONAL_STRENGTH,
            sortable: true,
            sortingType: "string",
        ...
        },
        {
            ...
            sortable: true,
            sortingType: "int",
            displayName: caption.WZM_STATUS,
        ...
        },
        {
            ...
            sortable: true,
            sortingType: "int",
            displayName: caption.WZM_MANIPULATION,
            cellTemplate: "<span ng-click='cellTemplateScope.edit(row.branch[col.field])' style='width: 25px; height: 25px; padding-right: 10px' class= '' > <i style='--fa-primary-color: green;' class='fa-solid fa-pen-to-square fs25'></i></span> <span ng-click='cellTemplateScope.delete(row.branch[col.field])' style='width: 25px; height: 25px; padding: 0px' class=''><i style='--fa-primary-color: red;' class='fa-solid fa-trash  fs25'></i></span>",
            cellTemplateScope: {
                edit: function (id) {
                    $scope.edit(id);
                },
...
app.controller('add', function ($scope, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, DTInstances, $uibModal, $confirm, $uibModalInstance, dataservice) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/WarehouseZoneManager/JtableAttributeEx",
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ZoneAttrCode').withTitle('{{"WZM_CODE_AND_NAME_ATTR" | translate}}').renderWith(function (data, type, full) {
    ...
    //    return data;
    //}));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ZoneAttrValue').withTitle('{{"WZM_VALUE_UNIT" | translate}}').renderWith(function (data, type, full) {
...
app.controller('add-attr', function ($scope, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, DTInstances, $uibModal, $confirm, $uibModalInstance, dataservice) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/WarehouseZoneManager/JtableAttribute",
            beforeSend: function (jqXHR, settings) {
                App.blockUI({
                    target: "#contentMain",
                    boxed: true,
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ZoneAttrCode').withTitle('{{"WZM_CODE_ATTR" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ZoneAttrName').withTitle('{{"WZM_NAME_ATTR" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ZoneAttrValue').withTitle('{{"WZM_VALUE_UNIT" | translate}}').renderWith(function (data, type, full) {
        return data + ' (' + full.ZoneAttrUnitName + ')';
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ZoneTypeName').withTitle('{{"WZM_STYPE_ZONE" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ZoneGroupName').withTitle('{{"WZM_GROUP_ZONE_BTN" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('action').notSortable().withOption('sClass', 'w75').withTitle('{{"COM_LIST_COL_ACTION" | translate}}').renderWith(function (data, type, full) {
        return '<a ng-click="edit(' + full.Id + ')" style = "width: 25px; height: 25px; padding-right: 10px" class=""><i style="--fa-primary-color: green;" class="fa-solid fa-pen-to-square fs25"></i></a>' +
