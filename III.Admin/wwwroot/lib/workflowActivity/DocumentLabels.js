Document_Label = draw2d.shape.flowchart.Document.extend({

    NAME: "draw2d.shape.node.Document_Hub",
    ...
    init: function(attr, setter, getter) {
        ...
        var _port = this.port = this.createPort("hybrid", new draw2d.layout.locator.LeftLocator());
    ...
    repaint: function(attributes) {
        ...
        if (typeof attributes.fill === "undefined") {
            if (this.bgColor !== null) {
                attributes.fill = "900-" + this.bgColor.hash() + ":5-" + this.bgColor.lighter(0.3).hash() + ":95";
            } else {
