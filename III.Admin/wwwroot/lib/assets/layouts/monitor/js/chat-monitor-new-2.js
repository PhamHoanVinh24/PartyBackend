...
function styleFunction() {
    ...
    if (zoom >= 8) {
        if (zoom >= 13) {
            //html = html + "</br>Đầu kéo: " + this.get("tracktorCode");
            //html = html + "</br>Romooc: " + this.get("romoocCode")
        }
        else if (8 <= zoom && zoom < 13) {
    ...
    return [
        ...
        new ol.style.Style({
            image: new ol.style.Icon(({
                ...
                src: 'https://www.upsieutoc.com/images/2019/04/07/ic_nv.png'
            })),
        })
    ];
}