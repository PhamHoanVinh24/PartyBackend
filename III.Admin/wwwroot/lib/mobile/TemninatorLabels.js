var Teminator_Label = draw2d.shape.basic.Rectangle.extend({

    NAME: "draw2d.shape.node.Teminator_Hub",


    DEFAULT_COLOR: new draw2d.util.Color("#27AE60"),
    BACKGROUND_COLOR: new draw2d.util.Color("#27AE60"),
    ...
    init: function(attr, setter, getter) {
        ...
        this._super(
            ...
            $.extend({ color: this.DEFAULT_COLOR.darker(), bgColor: this.BACKGROUND_COLOR, radius: 45 }, attr),
            $.extend({
                // deprecated
                label: this.setLabel,
