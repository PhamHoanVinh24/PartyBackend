        ...
        transit: function (callback1, callback2) {
            ...
            if ($body.hasClass('vertical-layout')) {
                if ($body.hasClass('menu-open') || $body.hasClass('menu-expanded')) {
                    $('.menu-toggle').addClass('is-active fa fa-arrow-circle-o-left');
                    ...
                    $('.menu-toggle').removeClass('is-active fa fa-arrow-circle-o-left');
                    $('.menu-toggle').addClass('fa fa-arrow-circle-o-right');
