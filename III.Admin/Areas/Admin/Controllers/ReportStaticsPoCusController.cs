...
namespace III.Admin.Controllers
{
    ...
    public class ReportStaticsPoCusController : BaseController
    {
        private readonly UserManager<AspNetUser> _userManager;
        private readonly RoleManager<AspNetRole> _roleManager;
        private readonly EIMDBContext _context;
        private readonly AppSettings _appSettings;
        private readonly IStringLocalizer<ReportStaticsPoCusController> _stringLocalizer;
        ...
        public ReportStaticsPoCusController(IOptions<AppSettings> appSettings, EIMDBContext context, UserManager<AspNetUser> userManager, RoleManager<AspNetRole> roleManager, EIMDBContext swContext, IStringLocalizer<ReportStaticsPoCusController> stringLocalizer, IStringLocalizer<SharedResources> sharedResources,
        ...
        [Breadcrumb("ViewData.CrumbPoCus", AreaName = "Admin", FromAction = "Index", FromController = typeof(ReportWareHouseHomeController))]
        public IActionResult Index()
        {
            ...
            ViewData["CrumbPoCus"] = _sharedResources["COM_CRUMB_PO_CUS"];
            return View();
        }


        public object JTable([FromBody]JTableReportStaticsPoCusModelCustom jTablePara)
        {
            var count = 0;
            var intBeginFor = 1;
            try
            {
                ...
                object[] val = new object[] { fromDate, toDate, jTablePara.ContractCode, jTablePara.CusCode, jTablePara.ProductCode, jTablePara.ProductType, intBeginFor + 1, intBeginFor + jTablePara.Length };
                ...
                var jdata = JTableHelper.JObjectTable(query, jTablePara.Draw, count, "Id", "ProductCode", "ProductType", "ProductTypeName", "ProductName", "ContractCode", "Title", "EffectiveDate", "ContractNo", "CusCode", "CusName", "ExchangeRate", "RevenueAfterTaxVnd", "TotalRevenueAfterTaxVnd");
                return Json(jdata);
            }
            catch (Exception ex)
            {
        ...
        //    var listExport = new List<ReportStaticsPoCusExportModel>();
        //    var no = 1;
        //    foreach (var item in query)
        //    {
        //        var itemExport = new ReportStaticsPoCusExportModel();
        //        itemExport.No = no;
    ...
    //public class ReportStaticsPoCusExportModel
    //{
    ...
    //}
    public class ReportStaticsPoCusGrid
    {
