...
{
    [Area("Admin")]
    [Route("Admin/ContractHome")]
    public class ContractHomeController : BaseController
    {
        ...
        public ContractHomeController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbContractHome", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuCenterController))]
