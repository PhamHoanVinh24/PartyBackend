...
{
    [Area("Admin")]
    public class FacebookSocialController : BaseController
    {
        ...
        public FacebookSocialController(EIMDBContext context, IStringLocalizer<FacebookSocialController> stringLocalizer,
        ...
        [Breadcrumb("ViewData.CrumbFacebookSocial", AreaName = "Admin", FromAction = "Index", FromController = typeof(LmsDashBoardController))]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuCenter"] = _sharedResources["COM_CRUMB_MENU_CENTER"];
            ViewData["CrumbLMSDashBoard"] = _sharedResources["COM_CRUMB_LMS_DASH_BOARD"];
            ViewData["CrumbFacebookSocial"] = _sharedResources["COM_BOT_FACEBOOK"];
            return View();
        }
        [HttpPost]
