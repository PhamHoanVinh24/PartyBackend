...
namespace III.Admin.Controllers
{
    ...
    public class MaterialProductAssetController : BaseController
    {
        ...
        [Breadcrumb("ViewData.CrumbProdAsset", AreaName = "Admin", FromAction = "Index", FromController = typeof(NomalListAssetHomeController))]
        public IActionResult Index()
        {
            ...
            ViewData["CrumbProdAsset"] = _sharedResources["COM_CRUMB_PROD_ASSET"];
            return View("Index");
        }
