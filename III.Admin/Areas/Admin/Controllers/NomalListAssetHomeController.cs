...
{
    [Area("Admin")]
    [Route("Admin/NomalListAssetHome")]
    public class NomalListAssetHomeController : BaseController
    {
        ...
        public NomalListAssetHomeController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbNormalAssetHome", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuAssetOperationController))]
