...
namespace III.Admin.Controllers
{
    ...
    [Area("Admin")]
    public class SupplierEventsController : BaseController
    {
        ...
        public SupplierEventsController(EIMDBContext context, IUploadService upload,
        ...
        public IActionResult Index()
        {
            ...
            ViewData["CrumbStaffRegistration"] = _sharedResources["Sự kiện nhà cung cấp"];
            return View();
        }
        ...
        public JsonResult GetAllEvent()
        {
            ...
            try
            {
                ...
                var events = (from a in _context.SupplierAppointments.Where(x => !x.IsDeleted)
                    join b in _context.Suppliers.Where(x => !x.IsDeleted) on a.SupplierCode equals b.SupCode
                ...
                foreach (var item in events)
                {
                    ...
                    var obj = new
                    {
                        item.Id,
                        item.Title,
                        ItemCode = item.SupCode,
                        ItemName = item.SupName,
