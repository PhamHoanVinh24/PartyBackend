...
{
    [Area("Admin")]
    [Route("Admin/MenuCenter")]
    public class MenuCenterController : BaseController
    {
        ...
        public MenuCenterController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbMenuCenter", AreaName = "Admin", FromAction = "Index", FromController = typeof(DashBoardController))]
