...
namespace III.Admin.Controllers
{
    ...
    public class UserManualEditorController : BaseController
    {
        ...
        public UserManualEditorController(EIMDBContext context, IUploadService upload, IHostingEnvironment hostingEnvironment, 
        ...
        [Breadcrumb("ViewData.CrumbUserManualEditorController", AreaName = "Admin", FromAction = "Index", FromController = typeof(ContentManageHomeController))]

        public IActionResult Index()
        {
			var COM_CRUMB_USER_MANUAL_EDITOR = "Hướng dẫn sử dụng";
            ...
            ViewData["CrumbUserManualEditorController"] = _sharedResources[COM_CRUMB_USER_MANUAL_EDITOR];
            return View();
        }
        ...
        public object JTable([FromBody]CMSItemsJTableModel jTablePara)
        {
            ...
            var query = from a in _context.cms_items
                        ...
                        && (a.cat_id.Equals(jTablePara.Category))
        ...
        {
            var data = _context.cms_categories.Where(x => x.published == true && x.extra_fields_group == 32).Select(x => new { Id = x.id, Name = x.name });
            return data.ToList();
        }
        [HttpPost]
        ...
        public List<TreeView> GetTreeData()
        {
            ...
            var data = _context.cms_categories.OrderBy(x => x.ordering).AsNoTracking();
        ...
        private List<TreeView> GetSubTreeData(List<cms_categories> data, int? Parent, List<TreeView> lstCategories, int tab)
        {
            ...
            foreach (var item in contents)
            {
                ...
                if ((item.extra_fields_group == 32 && category.Level == 0) || category.Level != 0)
                {
