...
namespace III.Admin.Controllers
{
    ...
    public class ProjectHomeController : BaseController
    {
        ...
        public ProjectHomeController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbProjectHome", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuCenterController))]
