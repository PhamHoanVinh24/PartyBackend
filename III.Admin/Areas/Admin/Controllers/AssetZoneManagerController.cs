...
{
    [Area("Admin")]
    public class AssetZoneManagerController : BaseController
    {
        private readonly EIMDBContext _context;
        private readonly IStringLocalizer<ZoneManagerController> _stringLocalizer;
        private readonly IStringLocalizer<SharedResources> _sharedResources;
        private readonly IHostingEnvironment _hostingEnvironment;
        public AssetZoneManagerController(EIMDBContext context, IStringLocalizer<ZoneManagerController> stringLocalizer, IStringLocalizer<SharedResources> sharedResources, IHostingEnvironment hostingEnvironment)
        {
            _context = context;
        ...
        public IActionResult Index()
        {
            ...
            ViewData["CrumbZoneManager"] = _sharedResources["Vùng lưu trữ (Tài sản)"];
            return View();
        }
        ...
        {
            var data = _context.AssetZoneStructs.Where(x => !x.IsDeleted && x.ZoneLevel != null).OrderBy(x => x.ZoneLevel).GroupBy(x => x.ZoneLevel).Select(x => new { Code = x.FirstOrDefault().ZoneLevel, Name = x.FirstOrDefault().ZoneLevel });
            return Json(data);
        }
        ...
        {
            var data = _context.AssetZoneStructs.Where(x => (string.IsNullOrEmpty(zoneCode) || !x.ZoneCode.Equals(zoneCode)) && !x.IsDeleted).Select(x => new { Id = x.ID, Code = x.ZoneCode, Name = x.ZoneName });
            return Json(data);
        }
        ...
        {
            var data = _context.AssetZoneStructs.Where(x => !x.IsDeleted);
            var dataOrder = GetSubTreeZone(data.ToList(), null, new List<TreeView>(), 0);
            return dataOrder;
        }

        private List<TreeView> GetSubTreeZone(List<AssetZoneStruct> data, string catParent, List<TreeView> lstCategories, int tab)
        {
        ...
        {
            var query = (from a in _context.AssetZoneStructs
                         ...
                         let attr = _context.AssetZoneAttrs.FirstOrDefault(x => !x.IsDeleted && x.ZoneAttrCode.Equals("QUANTITY") && x.ZoneGroup.Equals(a.ZoneGroup) && x.ZoneType.Equals(a.ZoneType))
                         let parent = _context.AssetZoneStructs.FirstOrDefault(x => x.ZoneCode.Equals(a.ZoneParent))
        ...
        {
            var query = from x in _context.AssetZoneStructs.Where(x => !x.IsDeleted)
        ...
        {
            var data = _context.AssetZoneStructs.FirstOrDefault(x => !x.IsDeleted && x.ZoneCode.Equals(zoneCode));
            if (data != null)
            {
                var listRecordsPack = _context.AssetZoneStructs.Where(x => !x.IsDeleted).ToList();
        ...
        private string GetHierarchy(List<AssetZoneStruct> listData, AssetZoneStruct obj, string hierarchy)
        {
        ...
        [HttpPost]
        public JsonResult Insert(AssetZoneStruct obj, IFormFile image)
        {
            ...
            try
            {
                ...
                if (listZone.Count > 1)
                {
                    ...
                    {
                        var checkExist = _context.AssetZoneStructs.FirstOrDefault(x => x.ZoneCode.Equals(item));
                        if (checkExist == null)
                        {
                            obj.CreatedBy = ESEIM.AppContext.UserName;
                            obj.CreatedTime = DateTime.Now;
                            _context.AssetZoneStructs.Add(obj);
                            countZoneSuccess++;
                        }
                        else
                        {
                ...
                {
                    var checkExist = _context.AssetZoneStructs.FirstOrDefault(x => x.ZoneCode.Equals(obj.ZoneCode));
                    if (checkExist == null)
                    {
                        obj.CreatedBy = ESEIM.AppContext.UserName;
                        obj.CreatedTime = DateTime.Now;
        ...
        public object GetItem(int id)
        {
            ...
            try
            {
                var data = _context.AssetZoneStructs.FirstOrDefault(x => x.ID == id);
                if (data != null)
                {
                    msg.Object = data;
                }
        ...
        [HttpPost]
        public JsonResult Update(AssetZoneStruct obj, IFormFile image)
        {
            var msg = new JMessage { Error = false, Title = "" };
            try
            {
                var data = _context.AssetZoneStructs.Where(x => x.ZoneCode.Equals(obj.ZoneCode)).FirstOrDefault();
                if (data != null)
                {
                    if (obj.ZoneLevel == null)
                    {
                    ...
                    _context.AssetZoneStructs.Update(data);
                    _context.SaveChanges();
        ...
        public object Delete(int Id)
        {
            ...
            try
            {
                ...
                if (data != null)
                {
                    ...
                    var listChild = _context.AssetZoneStructs.ToList().Where(x => !x.IsDeleted && !string.IsNullOrEmpty(x.ZoneHierachy) && x.ZoneHierachy.Split("/", StringSplitOptions.None).Any(p => p.Equals(data.ZoneCode)));
                    ...
                    foreach (var item in listChild)
                    {
                        ...
                        item.IsDeleted = true;
                        _context.AssetZoneStructs.Update(item);
                    }
        ...
        public object JTableAttributeEx([FromBody]JTableModelCustom jTablePara)
        {
            ...
            var query = from a in _context.AssetZoneAttrs.Where(x => !x.IsDeleted)
        ...
        [HttpPost]
        public JsonResult InsertAttribute([FromBody]AssetZoneAttr obj)
        {
            var msg = new JMessage { Error = false, Title = "" };
            try
            {
                var checkExist = _context.AssetZoneAttrs.FirstOrDefault(x => !x.IsDeleted && x.ZoneAttrCode.Equals(obj.ZoneAttrCode));
                if (checkExist == null)
                {
                    obj.CreatedBy = ESEIM.AppContext.UserName;
                    obj.CreatedTime = DateTime.Now;
                    _context.AssetZoneAttrs.Add(obj);
                    _context.SaveChanges();
        ...
        public object GetDetailAttribute(int id)
        {
            ...
            try
            {
                var data = _context.AssetZoneAttrs.FirstOrDefault(x => !x.IsDeleted && x.ID == id);
                if (data != null)
                {
                    msg.Object = data;
                }
        ...
        [HttpPost]
        public JsonResult UpdateAttribute([FromBody]AssetZoneAttr obj)
        {
            var msg = new JMessage { Error = false, Title = "" };
            try
            {
                var data = _context.AssetZoneAttrs.Where(x => !x.IsDeleted && x.ZoneAttrCode.Equals(obj.ZoneAttrCode)).FirstOrDefault();
                if (data != null)
                {
                    ...
                    data.UpdatedBy = ESEIM.AppContext.UserName;
                    data.UpdatedTime = DateTime.Now;
                    _context.AssetZoneAttrs.Update(data);
                    _context.SaveChanges();
