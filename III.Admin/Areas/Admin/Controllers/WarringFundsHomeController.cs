...
{
    [Area("Admin")]
    [Route("Admin/WarringFundsHome")]
    public class WarringFundsHomeController : BaseController
    {
        ...
        public WarringFundsHomeController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbWarningFundHome", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuFinanceController))]
