...
{
    [Area("Admin")]
    [Route("Admin/SupplierHome")]
    public class SupplierHomeController : BaseController
    {
        ...
        public SupplierHomeController(IOptions<AppSettings> appSettings, EIMDBContext context,
        ...
        [Breadcrumb("ViewData.CrumbSuppHome", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuCenterController))]
