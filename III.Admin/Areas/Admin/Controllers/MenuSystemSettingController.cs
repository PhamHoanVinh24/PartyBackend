...
{
    [Area("Admin")]
    [Route("Admin/MenuSystemSetting")]
    public class MenuSystemSettingController : BaseController
    {
        ...
        public MenuSystemSettingController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbMenuSystemSett", AreaName = "Admin", FromAction = "Index", FromController = typeof(DashBoardController))]
