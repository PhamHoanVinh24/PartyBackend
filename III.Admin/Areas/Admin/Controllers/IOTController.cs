...
namespace III.Admin.Controllers
{
    ...
    public class IOTController : BaseController
    {
        ...
        public IOTController(EIMDBContext context, IStringLocalizer<DashBoardController> stringLocalizer,
        ...
        public object GetCountWorkFlow()
        {
            ...
            var data = (from a in _context.WorkflowInstances.Where(x => !x.IsDeleted.Value)
                        ...
                        select new
                        {
                            ...
                            updatetime = a.CreatedTime.HasValue ? a.CreatedTime.Value.ToString("HH:mm dd/MM/yyyy") : ""
