...
{
    [Area("Admin")]
    [Route("Admin/ReportWareHouseHome")]
    public class ReportWareHouseHomeController : BaseController
    {
        ...
        public ReportWareHouseHomeController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbRptWHHome", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuStoreController))]
