...
{
    [Area("Admin")]
    [Route("Admin/MenuLogistic")]
    public class MenuLogisticController : BaseController
    {
        ...
        public MenuLogisticController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbMenuLogistic", AreaName = "Admin", FromAction = "Index", FromController = typeof(DashBoardController))]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuLogistic"] = /*_sharedResources["COM_CRUMB_MENU_FINANCE"]*/"Vận chuyển";
            return View();
        }
