...
{
    [Area("Admin")]
    public class ProductQRPackageManagerController : BaseController
    {
        ...
        public ProductQRPackageManagerController(EIMDBContext context, IStringLocalizer<ProductQRCodeManagerController> stringLocalizer, IStringLocalizer<EDMSQRCodeManagerController> stringLocalizerQRCODE, IStringLocalizer<SharedResources> sharedResources)
        {
            _context = context;
        ...
        public IActionResult Index()
        {
            ...
            ViewData["CrumbQrManage"] = "Quản lý QR Code pallet";
            return View();
        }
    }
}