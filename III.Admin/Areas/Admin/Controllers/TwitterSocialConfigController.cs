...
{
    [Area("Admin")]
    public class TwitterSocialConfigController : BaseController
    {
        ...
        public TwitterSocialConfigController(EIMDBContext context, IStringLocalizer<ExamHomeController> stringLocalizer,
        ...
        [Breadcrumb("ViewData.CrumbTwitterSocialConfig", AreaName = "Admin", FromAction = "Index", FromController = typeof(LmsDashBoardController))]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuCenter"] = _sharedResources["COM_CRUMB_MENU_CENTER"];
            ViewData["CrumbLMSDashBoard"] = _sharedResources["COM_CRUMB_LMS_DASH_BOARD"];
            ViewData["CrumbTwitterSocialConfig"] = _sharedResources["COM_BOT_TWITTER_CONFIG"];
            return View();
        }
                [HttpPost]
