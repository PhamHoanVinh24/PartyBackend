...
{
    [Area("Admin")]
    public class CrawlerDataController : BaseController
    {
        ...
        public CrawlerDataController(EIMDBContext context, IUploadService upload, IHostingEnvironment hostingEnvironment,
        ...
        public IActionResult Index()
        {
            ...
            ViewData["CrumbCrawlerData"] = "Dữ liệu crawling";//_sharedResources["COM_CRUMB_LMS_COURSEWARE"];
            return View();
        }
