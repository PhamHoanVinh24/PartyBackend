...
{
    [Area("Admin")]
    public class FacebookSocialConfigController : BaseController
    {
        ...
        private readonly IStringLocalizer<FacebookSocialConfigController> _stringLocalizerFsc;
        ...
        public FacebookSocialConfigController(EIMDBContext context, IStringLocalizer<ExamHomeController> stringLocalizer,
            IStringLocalizer<LmsDashBoardController> stringLocalizerLms,
            IStringLocalizer<CrawlerMenuController> stringLocalizerCRAW,
            IStringLocalizer<FacebookSocialConfigController> stringLocalizerFsc,
            ...
            IStringLocalizer<SharedResources> sharedResources)
        {
            ...
            _stringLocalizerFsc = stringLocalizerFsc;
        ...
        [Breadcrumb("ViewData.CrumbFacebookCocialConfig", AreaName = "Admin", FromAction = "Index", FromController = typeof(LmsDashBoardController))]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuCenter"] = _sharedResources["COM_CRUMB_MENU_CENTER"];
            ViewData["CrumbLMSDashBoard"] = _sharedResources["COM_CRUMB_LMS_DASH_BOARD"];
            ViewData["CrumbFacebookCocialConfig"] = _sharedResources["COM_BOT_FACEBOOK_CONFIG"];
            return View();
        }
        ...
        [HttpPost]
        public Object GetLstUnjoinGroup()
        {
            return _context.CrawlerInfoFacebookGroups.Where(x => x.IsJoin == false && x.OwnedBot == null).Select(x => new
            {
                id = x.GroupId,
                label = x.GroupName,
                member = x.MemberCount,
            }).OrderByDescending(a => a.member);
        }
        #endregion
        #endregion
        #region Language
        ...
        public IActionResult Translation(string lang)
        {
            ...
            var query = _stringLocalizer.GetAllStrings().Select(x => new { x.Name, x.Value })
                ...
                .Union(_stringLocalizerFsc.GetAllStrings().Select(x => new { x.Name, x.Value }))
