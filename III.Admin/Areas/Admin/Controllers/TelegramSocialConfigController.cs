...
{
    [Area("Admin")]
    public class TelegramSocialConfigController : BaseController
    {
        ...
        public TelegramSocialConfigController(EIMDBContext context, IStringLocalizer<ExamHomeController> stringLocalizer,
        ...
        [Breadcrumb("ViewData.CrumbTelegramSocialConfig", AreaName = "Admin", FromAction = "Index", FromController = typeof(LmsDashBoardController))]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuCenter"] = _sharedResources["COM_CRUMB_MENU_CENTER"];
            ViewData["CrumbLMSDashBoard"] = _sharedResources["COM_CRUMB_LMS_DASH_BOARD"];
            ViewData["CrumbTelegramSocialConfig"] = _sharedResources["COM_BOT_TELEGRAM_CONFIG"];
            return View();
        }
