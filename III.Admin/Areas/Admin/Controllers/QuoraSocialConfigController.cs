...
{
    [Area("Admin")]
    public class QuoraSocialConfigController : BaseController
    {
        ...
        public QuoraSocialConfigController(EIMDBContext context, IStringLocalizer<ExamHomeController> stringLocalizer,
        ...
        [Breadcrumb("ViewData.CrumbQuoraSocialConfig", AreaName = "Admin", FromAction = "Index", FromController = typeof(LmsDashBoardController))]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuCenter"] = _sharedResources["COM_CRUMB_MENU_CENTER"];
            ViewData["CrumbLMSDashBoard"] = _sharedResources["COM_CRUMB_LMS_DASH_BOARD"];
            ViewData["CrumbQuoraSocialConfig"] = _sharedResources["COM_BOT_QUORA_CONFIG"];
            return View();
        }
