...
{
    [Area("Admin")]
    public class ProductQRInStockManagerController : BaseController
    {
        ...
        public ProductQRInStockManagerController(EIMDBContext context, IStringLocalizer<ProductQRCodeManagerController> stringLocalizer, IStringLocalizer<EDMSQRCodeManagerController> stringLocalizerQRCODE, IStringLocalizer<SharedResources> sharedResources)
        {
            _context = context;
        ...
        public IActionResult Index()
        {
            ...
            ViewData["CrumbQrManage"] = "Quản lý QR Code tồn kho";
            return View();
        }
    }
}