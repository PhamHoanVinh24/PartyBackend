...
{
    [Area("Admin")]
    public class QuoraSocialController : BaseController
    {
        ...
        public QuoraSocialController(EIMDBContext context, /*IStringLocalizer<FacebookSocialController> stringLocalizer,*/
        ...
        [Breadcrumb("ViewData.CrumbQuoraSocial", AreaName = "Admin", FromAction = "Index", FromController = typeof(LmsDashBoardController))]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuCenter"] = _sharedResources["COM_CRUMB_MENU_CENTER"];
            ViewData["CrumbLMSDashBoard"] = _sharedResources["COM_CRUMB_LMS_DASH_BOARD"];
            ViewData["CrumbQuoraSocial"] = _sharedResources["COM_BOT_QUORA"];
            return View();
        }
        [HttpPost]
