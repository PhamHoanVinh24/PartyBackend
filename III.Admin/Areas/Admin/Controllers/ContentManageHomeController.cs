...
{
    [Area("Admin")]
    [Route("Admin/ContentManageHome")]

    public class ContentManageHomeController : BaseController
    {
        ...
        public ContentManageHomeController(IOptions<AppSettings> appSettings, EIMDBContext context,
        ...
        [Breadcrumb("ViewData.CrumbContentManage", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuSystemSettingController))]
