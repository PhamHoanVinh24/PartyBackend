...
{
    [Area("Admin")]
    public class InstagramSocialController : BaseController
    {
        ...
        private readonly IStringLocalizer<BotRunningController> _stringLocalizerBrn;
        ...
        public InstagramSocialController(EIMDBContext context, IStringLocalizer<ExamHomeController> stringLocalizer,
            IStringLocalizer<LmsDashBoardController> stringLocalizerLms,
            IStringLocalizer<CrawlerMenuController> stringLocalizerCRAW,
            IStringLocalizer<BotRunningController> stringLocalizerBrn,
            ...
            IStringLocalizer<SharedResources> sharedResources)
        {
            ...
            _stringLocalizerBrn = stringLocalizerBrn;
        ...
        [Breadcrumb("ViewData.CrumbInstagramCocial", AreaName = "Admin", FromAction = "Index", FromController = typeof(LmsDashBoardController))]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuCenter"] = _sharedResources["COM_CRUMB_MENU_CENTER"];
            ViewData["CrumbLMSDashBoard"] = _sharedResources["COM_CRUMB_LMS_DASH_BOARD"];
            ViewData["CrumbInstagramCocial"] = _sharedResources["COM_BOT_INSTAGRAM"];
            return View();
        }
        ...
        public IActionResult Translation(string lang)
        {
            ...
            var query = _stringLocalizer.GetAllStrings().Select(x => new { x.Name, x.Value })
                ...
                .Union(_stringLocalizerBrn.GetAllStrings().Select(x => new { x.Name, x.Value }))
