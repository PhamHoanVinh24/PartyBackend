...
{
    [Area("Admin")]
    [Route("Admin/NomalListWareHouseHome")]
    public class NomalListWareHouseHomeController : BaseController
    {
        ...
        public NomalListWareHouseHomeController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbNormalWHHome", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuStoreController))]
