...
{
    [Area("Admin")]
    public class TiktokSocialController : BaseController
    {
        private readonly EIMDBContext _context;
        private readonly IUploadService _upload;
        private readonly IStringLocalizer<TiktokSocialController> _stringLocalizer;
        ...
        public TiktokSocialController(EIMDBContext context, IStringLocalizer<TiktokSocialController> stringLocalizer,
        ...
        [Breadcrumb("ViewData.CrumbTiktokSocial", AreaName = "Admin", FromAction = "Index", FromController = typeof(LmsDashBoardController))]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuCenter"] = _sharedResources["COM_CRUMB_MENU_CENTER"];
            ViewData["CrumbLMSDashBoard"] = _sharedResources["COM_CRUMB_LMS_DASH_BOARD"];
            ViewData["CrumbTiktokSocial"] = _sharedResources["COM_BOT_TIKTOK"];
            return View();
        }
