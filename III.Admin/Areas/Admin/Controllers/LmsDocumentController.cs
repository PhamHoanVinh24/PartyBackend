...
{
    [Area("Admin")]
    public class LmsDocumentController : BaseController
    {
        private readonly EIMDBContext _context;
        private readonly IUploadService _upload;
        private readonly IHostingEnvironment _hostingEnvironment;
        private readonly IStringLocalizer<LmsDocumentController> _stringLocalizer;
        ...
        public LmsDocumentController(EIMDBContext context, IUploadService upload, IHostingEnvironment hostingEnvironment,
            IStringLocalizer<LmsDocumentController> stringLocalizer,
             IStringLocalizer<LmsDashBoardController> stringLocalizerLms,
            IStringLocalizer<EDMSRepositoryController> stringLocalizerEdms, IStringLocalizer<ContractController> contractController,
        ...
        public IActionResult Index()
        {
            ...
            ViewData["CrumbLMSDocument"] = _sharedResources["COM_CRUMB_LMS_DOCUMENT"];
            return View();
        }
        ...
        private List<TreeViewResource> GetSubTreeCategoryData(List<EDMSCategory> data, string parentid, List<TreeViewResource> lstCategories, int tab, int typeOrder)
        {
            ...
            foreach (var item in contents)
            {
                ...
                if ((category.Code == "LMS_DOCUMENTS" && category.Level == 0) || category.Level != 0)
                {
        ...
        public object JTableFile([FromBody] JtableFileModel jTablePara)
        {
            ...
            try
            {
                ...
                {
                    return JtableWithContent(jTablePara, fromDate, toDate, listFileByUser, session, listType, intBeginFor);
                }
                else
                {
                    if (!jTablePara.RecentFile)
                    {
                        return JTableNotRecent(jTablePara, fromDate, toDate, listFileByUser, session, listType, intBeginFor);
                    }
                    else
                    {
                        return JTableRecent(jTablePara, fromDate, toDate, listFileByUser, session, listType, intBeginFor);
                    }
                }
            }
            catch (Exception ex)
        ...
        [NonAction]
        private object JtableWithContent(JtableFileModel jTablePara, DateTime? fromDate, DateTime? toDate, List<FileByUser> listFileByUser, SessionUserLogin session, string[] listType, int intBeginFor)
        {
        ...
        private object JTableNotRecent(JtableFileModel jTablePara, DateTime? fromDate, DateTime? toDate,
            List<FileByUser> listFileByUser, SessionUserLogin session, string[] listType, int intBeginFor)
        {
        ...
        {
            var msg = new JMessage() { Error = false, Title = "LMS_DOCUMENT_MSG_SUCCESSFUL" };
            try
            {
                if (obj.Action == "Copy" || obj.Action == "Move")
                {
                    ...
                    if (edmsFileOld != null)
                    {
                        ...
                        {
                            msg.Error = true;
                            msg.Title = "LMS_DOCUMENT_MSG_FOLDER_NOT_FILE";
                        }
                    }
                }
            }
        ...
        {
            var msg = new JMessage() { Error = false, Title = "LMS_DOCUMENT_MSG_COPY_SUCCESSFUL" };
            try
            {
        ...
        {
            var msg = new JMessage() { Error = false, Title = "LMS_DOCUMENT_MSG_MOVE_SUCCESSFUL" };
            try
            {
        ...
        {
            var msg = new JMessage() { Error = false, Title = "LMS_DOCUMENT_MSG_DOWNLOAD_SUCCESSFUL" };
            try
            {
        ...
        public JsonResult InsertFileShare([FromBody] FileShareModel obj)
        {
            ...
            try
            {
                ...
                msg.Title = "LMS_DOCUMENT_MSG_SHARE_SUCCESSFUL";
            }
            catch (Exception ex)
            {
                msg.Error = true;
        ...
        public object InsertPack([FromBody] ObjectiverPackCover data)
        {
            ...
            try
            {
                ...
                {
                    msg.Error = true;
                    msg.Title = String.Format(_stringLocalizer["LMS_DOCUMENT_ADD_ERR_EXIST"], "");//mã đã tồn tại
                }
            }
            catch (Exception ex)
            {
        ...
        public object GetItemPack(int id)
        {
            ...
            try
            {
                ...
                {
                    msg.Error = true;
                    msg.Title = String.Format(_stringLocalizer["LMS_DOCUMENT_ADD_ERR_NOT_EXIST"], "");//mã không tồn tại
                }
            }
            catch (Exception ex)
            {
        ...
        public object DeletePack(int id)
        {
            ...
            try
            {
                ...
                {
                    msg.Error = true;
                    msg.Title = String.Format(_stringLocalizer["LMS_DOCUMENT_ADD_ERR_NOT_EXIST"], "");//mã không tồn ại
                }
            }
            catch (Exception ex)
            {
        ...
        public JsonResult GetListMetaType()
        {
            ...
            try
            {
                ...
                {
                    msg.Error = true;
                    msg.Title = "LMS_DOCUMENT_MSG_NOT_EXIST_DATA";
                }
            }
            catch (Exception ex)
            {
                msg.Error = true;
                msg.Title = "LMS_DOCUMENT_MSG_ERR_DATA";
            }
            return Json(msg);
        }
        [HttpPost]
        ...
        public object UpdateMetaData(int? fileId, string metaDataExt)
        {
            ...
            try
            {
                ...
                {
                    msg.Error = true;
                    msg.Title = String.Format(_stringLocalizer["LMS_DOCUMENT_MSG_FILE_NOT_EXIST"], "");//tệp tin không tồn tại
                }
            }
            catch (Exception ex)
            {
