...
{
    [Area("Admin")]
    public class YoutubeSocialConfigController : BaseController
    {
        ...
        public YoutubeSocialConfigController(EIMDBContext context, IStringLocalizer<ExamHomeController> stringLocalizer,
        ...
        [Breadcrumb("ViewData.CrumbYoutubeSocialConfig", AreaName = "Admin", FromAction = "Index", FromController = typeof(LmsDashBoardController))]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuCenter"] = _sharedResources["COM_CRUMB_MENU_CENTER"];
            ViewData["CrumbLMSDashBoard"] = _sharedResources["COM_CRUMB_LMS_DASH_BOARD"];
            ViewData["CrumbYoutubeSocialConfig"] = _sharedResources["COM_BOT_YOUTUBE_CONFIG"];
            return View();
        }
