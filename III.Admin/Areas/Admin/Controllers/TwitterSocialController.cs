...
{
    [Area("Admin")]
    public class TwitterSocialController : BaseController
    {
        private readonly EIMDBContext _context;
        private readonly IUploadService _upload;
        private readonly IStringLocalizer<TwitterSocialController> _stringLocalizer;
        ...
        public TwitterSocialController(EIMDBContext context, IStringLocalizer<TwitterSocialController> stringLocalizer,
        ...
        [Breadcrumb("ViewData.CrumbTwtitterSocial", AreaName = "Admin", FromAction = "Index", FromController = typeof(LmsDashBoardController))]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuCenter"] = _sharedResources["COM_CRUMB_MENU_CENTER"];
            ViewData["CrumbLMSDashBoard"] = _sharedResources["COM_CRUMB_LMS_DASH_BOARD"];
            ViewData["CrumbTwtitterSocial"] = _sharedResources["COM_BOT_TWITTER"];
            return View();
        }
