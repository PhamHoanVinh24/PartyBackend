...
{
    [Area("Admin")]
    public class BotSocialSessionLogController : BaseController
    {
        ...
        public BotSocialSessionLogController(EIMDBContext context, IStringLocalizer<ExamHomeController> stringLocalizer,
        ...
        public object JTable([FromBody] JTableModel jTablePara)
        {
            ...
            var query = from a in _context.BotSocialSessionLog
                        select new
                        {
                            a.Id,
                            a.BotSocialCode,
            ...
            var jdata = JTableHelper.JObjectTable(data, jTablePara.Draw, count, "Id", "BotSocialCode", "BotSessionResult", "BotSession", "FileResults", "EndTime", "StartTime", "RuningType", "Statvs", "CreatedTime", "CreatedBy", "UpdatedTime", "UpdatedBy", "IsDeleted", "DeletedBy", "DeletedTime");
            return Json(jdata);
        }
        [HttpPost]
