...
{
    [Area("Admin")]
    [Route("Admin/IotHomeSetup")]
    public class IotHomeSetupController : BaseController
    {
        ...
        public IotHomeSetupController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbIotHome", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuSystemSettingController))]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuSystemSett"] = _sharedResources["COM_CRUMB_SYSTEM"];
            ViewData["CrumbIotHome"] = "Thiết bị và hạ tầng";
            return View();
        }
