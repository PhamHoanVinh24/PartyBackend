...
{
    [Area("Admin")]
    [Route("/Admin/MenuWfSystem")]
    public class MenuWfSystemController : BaseController
    {
        ...
        public MenuWfSystemController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbMenuWfSystem", AreaName = "Admin", FromAction = "Index", FromController = typeof(DashBoardController))]
        [AdminAuthorize]
