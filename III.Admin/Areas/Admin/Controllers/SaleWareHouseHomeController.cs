...
{
    [Area("Admin")]
    [Route("Admin/SaleWareHouseHome")]
    public class SaleWareHouseHomeController : BaseController
    {
        ...
        public SaleWareHouseHomeController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbSaleWHHome", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuStoreController))]
