...
{
    [Area("Admin")]
    public class ZaloSocialController : BaseController
    {
        ...
        public ZaloSocialController(EIMDBContext context, IStringLocalizer<FacebookSocialController> stringLocalizer,
