...
{
    [Area("Admin")]
    [Route("Admin/PaymentMenu")]
    public class PaymentMenuController : BaseController
    {
        ...
        public PaymentMenuController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbPaymentMenu", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuCenterController))]
