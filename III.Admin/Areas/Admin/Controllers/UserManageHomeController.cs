...
{
    [Area("Admin")]
    [Route("Admin/UserManageHome")]
    public class UserManageHomeController : BaseController
    {
        ...
        public UserManageHomeController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbUserManageHome", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuSystemSettingController))]
        [AdminAuthorize]
