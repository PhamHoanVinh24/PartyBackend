...
{
    [Area("Admin")]
    public class LinkedinSocialController : BaseController
    {
        ...
        public LinkedinSocialController(EIMDBContext context, IStringLocalizer<FacebookSocialController> stringLocalizer,
        ...
        [Breadcrumb("ViewData.CrumbLinkedinSocial", AreaName = "Admin", FromAction = "Index", FromController = typeof(LmsDashBoardController))]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuCenter"] = _sharedResources["COM_CRUMB_MENU_CENTER"];
            ViewData["CrumbLMSDashBoard"] = _sharedResources["COM_CRUMB_LMS_DASH_BOARD"];
            ViewData["CrumbLinkedinSocial"] = _sharedResources["COM_BOT_LINKEDIN"];
            return View();
        }
        [HttpPost]
