...
{
    [Area("Admin")]
    [Route("Admin/ServiceHome")]
    public class ServiceHomeController : BaseController
    {
        ...
        public ServiceHomeController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbServiceHome", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuStoreController))]
