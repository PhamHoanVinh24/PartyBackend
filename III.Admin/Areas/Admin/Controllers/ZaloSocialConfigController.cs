...
{
    [Area("Admin")]
    public class ZaloSocialConfigController : BaseController
    {
        ...
        public ZaloSocialConfigController(EIMDBContext context, IStringLocalizer<ExamHomeController> stringLocalizer,
