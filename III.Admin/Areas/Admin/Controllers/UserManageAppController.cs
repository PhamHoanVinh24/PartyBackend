...
{
    [Area("Admin")]
    [Route("Admin/UserManageApp")]
    public class UserManageAppController : BaseController
    {
        ...
        public UserManageAppController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbUserManageApp", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuSystemSettingController))]
        [AdminAuthorize]
        public IActionResult Index()
        {
            ViewData["CrumbDashBoard"] = _sharedResources["COM_CRUMB_DASH_BOARD"];
            ViewData["CrumbMenuSystemSett"] = _sharedResources["COM_CRUMB_SYSTEM"];
            ViewData["CrumbUserManageApp"] = _sharedResources["COM_CRUMB_APP_MANAGE"];
            return View();
        }
