...
namespace III.Admin.Controllers
{
    ...
    public class EmployeeHomeController : BaseController
    {
        ...
        public EmployeeHomeController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbEmployeeHome", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuCenterController))]
