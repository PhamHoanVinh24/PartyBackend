...
{
    [Area("Admin")]
    [Route("Admin/FundsHome")]
    public class FundsHomeController : BaseController
    {
        ...
        public FundsHomeController(IOptions<AppSettings> appSettings, EIMDBContext context,
        ...
        [Breadcrumb("ViewData.CrumbFundHome", AreaName = "Admin", FromAction = "Index", FromController = typeof(MenuFinanceController))]
