...
{
    [Area("Admin")]
    [Route("Admin/MenuFinance")]
    public class MenuFinanceController : BaseController
    {
        ...
        public MenuFinanceController(IOptions<AppSettings> appSettings, EIMDBContext context, 
        ...
        [Breadcrumb("ViewData.CrumbMenuFinance", AreaName = "Admin", FromAction = "Index", FromController = typeof(DashBoardController))]
